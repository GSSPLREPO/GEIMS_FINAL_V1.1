        ...
        <div id="divContent" style="height: 100%; font-family: Verdana;">
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                ...
                <div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
                   <%-- <ul>
                        <li><a id="tabClassDetails" href="#tabs-1">Leave Details</a></li>
                    </ul>--%>
                        ...
                        <div style="width: 100%;">
                            <div class="divclasswithfloat">
                                ...
                                <div style="text-align: left; width: 80%; float: left;">
                                    <asp:TextBox ID="txtLeaveName" runat="server" CssClass="validate[required] TextBox" Width="50%" Height="100%"></asp:TextBox>
                                </div>
                            </div>
                            <div class="divclasswithfloat">
                                <div style="text-align: left; width: 20%; float: left;" class="label">
                                ...
                                <div style="text-align: left; float: left; width: 20%;">
                                    <asp:TextBox ID="txtLeaveCode" runat="server" CssClass="validate[required] TextBox" Width="50%" Height="100%"></asp:TextBox>
                                </div>
                            </div>
