<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="GEIMS.Accounting.Payment" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
	...
	<script language="javascript" type="text/javascript">
	    function makeCreditSum() {
	        var gridViewID = "<%=gvPaymentsEntry.ClientID %>";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<script type="text/javascript">
	    $(function () {
	        $('#id_search').quicksearch('table#<%=gvPayments.ClientID%> tbody tr');
		})
	</script>
			...
			<div id="divContent2" style="width: 80%; float: left; height: 100%;">
				...
				<div id="divGrid" runat="server" style="text-align: center; padding-top: 10px; padding-bottom: 10px; padding-right:10px; width: 100%;">
					...
					<asp:GridView ID="gvPayments" runat="server" AutoGenerateColumns="False"
						...
						Font-Names="verdana" Font-Size="12px" Width="100%" BackColor="White" OnPreRender="gvPayments_PreRender" OnRowCommand="gvPayments_RowCommand" OnRowEditing="gvPayments_RowEditing" OnSelectedIndexChanged="gvPayments_SelectedIndexChanged">
				...
				<div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
					<ul>
						<li><a id="tabStudentTemplateDetails" href="#tabs-1">Payment</a></li>
					</ul>
					<div id="tabs-1" style="padding:0 0 0 10px" class="gradientBoxesWithOuterShadows">
						...
						<div class="divclasswithfloat">
							<div style="text-align: left; width: 15%; float: left;" class="label">
								Budget Section :<span class="Required">*</span>
							</div>
							<div style="text-align: left; width: 35%; float: left;">
						...
						<div class="divclasswithfloat" width="100%">
							<div class="label" align="center">
								<asp:GridView ID="gvPaymentsEntry" runat="server" AutoGenerateColumns="False" ShowFooter="True" Width="776px" >
									<Columns>
										<asp:BoundField HeaderText="Payment No." DataField="ReceiptPaymentID">
										...
										<asp:TemplateField HeaderText="Debit Amount">
											<ItemTemplate>
												<asp:TextBox ID="txtDebitAmount" runat="server" CssClass="TextBox" onchange="return makeCreditSum()"
											...
											<FooterTemplate>
												<input id="txtDebitSum" runat="server" class="TextBox" disabled="disabled" style="text-align: right; width: 100px; height: 13px;" type="text" value="0" />
											</FooterTemplate>
										</asp:TemplateField>
