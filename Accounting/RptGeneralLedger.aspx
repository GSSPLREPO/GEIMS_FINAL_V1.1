<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="RptGeneralLedger.aspx.cs" Inherits="GEIMS.Accounting.RptGeneralLedger" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(function () {
            $('#id_search').quicksearch('table#<%=gvGeneralLedgerReport.ClientID%> tbody tr');
	    })
    </script>
                ...
                <div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%; height: 100%; float: left;">
                    ...
                    <div id="tabs-1" class="gradientBoxesWithOuterShadows">
                        ...
                        <div style="float: left; width: 100%; text-align: center">
                            <div><b>Ledger Selection<br/></b></div>
                            <asp:GridView ID="gvParameter" runat="server" AutoGenerateColumns="False"
                                BorderColor="#3B5998" BorderWidth="3px" BorderStyle="Solid" CellPadding="4" GridLines="Both"
                                Font-Names="verdana" Font-Size="12px" BackColor="White" HorizontalAlign="Center">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="LedgerName" HeaderText="Account Name">
                                        <HeaderStyle BackColor="#3B5998" HorizontalAlign="Center" VerticalAlign="Middle"
                ...
                <div id="divGrid" runat="server" style="text-align: center; padding-top: 10px; padding-bottom: 10px; width: 100%;">
                    ...
                    <div class="divclasswithfloat">
                        <div style="text-align: left; width: 1070px; float: left;">
                            <asp:GridView ID="gvGeneralLedgerReport" runat="server" AutoGenerateColumns="False" OnPreRender="gvGeneralLedgerReport_OnPreRender"
                                BorderColor="#3B5998" BorderWidth="3px" BorderStyle="Solid" CellPadding="4" GridLines="Both" OnRowDataBound="gvGeneralLedgerReport_OnRowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Particulars" HeaderText="Particulars" HtmlEncode="False">
                                        ...
                                        <ItemStyle HorizontalAlign="left" Width="40%" Height="100%" VerticalAlign="Top" Wrap="true" />
                                    </asp:BoundField>
