...
namespace GEIMS.BO
{
    public class BudgetSubHeadingMBO
    {
        #region Budget Category Class Properties

        public const string BudgetSubHeading_TABLE = "tbl_BudgetSubHeading_M";
        ...
        public const string BudgetHeading_SUBHEADINGNAME = "SubHeadingName";
        ...
        private string strSubHeadingName = string.Empty;
        ...
        {
            get { return strSubHeadingName; }
            set { strSubHeadingName = value; }
        }
