<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Class_Template.aspx.cs" Inherits="GEIMS.Client.UI.Class_Template" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div id="divContent" style="height: 100%; font-family: Verdana;">
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                ...
                <div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
                    <ul>
                        <li><a id="tabClassTemplateDetails" href="#tabs-1">Class Fee Template Details</a></li>
                                ...
                                <asp:GridView ID="gvFees" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                     ...
                                     <%--   <asp:TemplateField HeaderText="Amount In Rs.">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtFeesAmount" runat="server" Width="300px" CssClass="validate[custom[onlyNumberSp]] TextBox" onblur="howManyDecimals(this.id,'#FFDFDF')" onkeypress="return NumericKeyPressFraction(event)" Style="text-align: right;">0</asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                                             <asp:TemplateField HeaderText="Amount In Rs. [Male]">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtFeesAmountForMale" runat="server" Width="300px" CssClass="validate[custom[onlyNumberSp]] TextBox" onblur="howManyDecimals(this.id,'#FFDFDF')" onkeypress="return NumericKeyPressFraction(event)" Style="text-align: right;">0</asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Amount In Rs. [Female]">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtFeesAmountForFemale" runat="server" Width="300px" CssClass="validate[custom[onlyNumberSp]] TextBox" onblur="howManyDecimals(this.id,'#FFDFDF')" onkeypress="return NumericKeyPressFraction(event)" Style="text-align: right;">0</asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
    ...
    <script type="text/javascript">
        ...
        $('#<%=gvFees.ClientID %>').find("input:text").change(function () {
