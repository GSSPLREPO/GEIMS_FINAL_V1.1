        ...
        <div id="divContent" style="height: 100%; font-family: Verdana;">
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                    ...
                    <div id="search">
                        <input id="id_search" type="text" placeholder="Search" onkeydown="return (event.keyCode!=13);">
                                    ...
                                    <asp:GridView ID="gvBudgetScreen" runat="server"
                                            ...
                                            Font-Names="verdana" Font-Size="12px" Width="100%" BackColor="White" ShowHeaderWhenEmpty="True" ShowFooter="True" OnRowCreated="gvBudgetScreen_RowCreated" OnRowCommand="gvBudgetScreen_RowCommand" OnPreRender="gvBudgetScreen_PreRender" OnRowDataBound="gvBudgetScreen_RowDataBound">
                ...
                <div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
                    <ul>
                        <li><a id="tabClassDetails" href="#tabs-1">Budget Entry</a></li>
                    </ul>
                            ...
                            <div class="divclasswithfloat" >
                               <%-- <div style="text-align: left; width: 20%; float: left;" class="label">
                                ...
                                <div style="text-align: left; width: 80%; float: left;">
                                    ...
                                    <div style="width: 100%;" class="divclasswithfloat">                    
                                        ...
                                        <div style="text-align: left; width: 30%; float: left;">
                                            <%--<asp:DropDownList runat="server" CssClass="validate[required] Droptextarea" ID="ddlAcademicYear" Enabled="false" Width="40%" >
                                             ...
                                             <asp:TextBox ID="txtAcademicYear" runat="server" CssClass="TextBox" ReadOnly="true" Width="28%" Style="text-align:right;"  ></asp:TextBox>    
                                             <asp:HiddenField ID="hfAcademicYear" runat="server" />
                                        </div>
                                    </div>
                                    <div style="width: 30%; float: left;">
                                        <p>Budget Category<span style="color: red">*</span></p>                                      
                                         <asp:DropDownList ID="ddlBudgetCategory" CssClass="validate[required] Droptextarea" runat="server" AutoPostBack="True" Width="80%" OnSelectedIndexChanged="ddlBudgetCategory_SelectedIndexChanged">
                                            <asp:ListItem Value="-1">-Select-</asp:ListItem>                                          
                                        </asp:DropDownList>
                                    </div>
                                    <div style="width: 30%; float: left;">
                                        <p>Budget Heading<span style="color: red">*</span></p>                                      
                                    ...
                                    <div style="width: 30%; float: left;">
                                          <p>Budget SubHeading<span style="color: red">*</span></p>
                                        <asp:DropDownList ID="ddlBudgetSubHeading"  CssClass="validate[required] Droptextarea" runat="server" AutoPostBack="False" Width="80%">
                                            <asp:ListItem Value="-1">-Select-</asp:ListItem>                                          
                                        </asp:DropDownList>                                      
                                    </div>                    
                            </div>
