        ...
        <div id="divContent" style="height: 100%; font-family: Verdana;">
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                <div id="Div1" align="center">
					Financial Year : <asp:Label ID="lblDuration" runat="server" CssClass="label"></asp:Label>
				</div>
                ...
                <div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
                    <ul>
                        <li><a id="tabClassDetails" href="#tabs-1">Budget Capital Cost</a></li>
                    </ul>
                    <div id="tabs-1" style="height: 250px;padding:5px 5px 5px 5px" class="gradientBoxesWithOuterShadows">
                        <div style="width: 100%; float: left;">
                            <div class="divclasswithfloat">                     
                                   <div style="text-align: left; width: 15%; float: left;">
                                       <p>Financial Year</p>
                                       <%--<asp:DropDownList runat="server" CssClass="validate[required] Droptextarea" ID="ddlAcademicYear" Enabled="false" Width="40%" >
                                       </asp:DropDownList>--%>
                                       <asp:TextBox ID="txtAcademicYear" runat="server" CssClass="TextBox" Width="60%" Height="100%" ReadOnly="true"  Style="text-align:right;"  ></asp:TextBox>    
                                       <asp:HiddenField ID="hfAcademicYear" runat="server" />
                                   </div>
                                  <div style="width: 27%; float: left;">
                                     <p>Section<span style="color: red">*</span></p>                                      
                                     <asp:DropDownList ID="ddlSection"  CssClass="validate[required] TextBox" runat="server"  Width="100%" Height="25px" AutoPostBack="True"  >
                            ...
                            <div class="divclasswithfloat" >   
                                    ...
                                    <div style="width: 15%; float: left;">
                                        <p>Heading<span style="color: red">*</span></p>                                      
                                         <asp:DropDownList ID="ddlBudgetHeading"  CssClass="validate[required] Droptextarea" runat="server" AutoPostBack="True" Width="80%" OnSelectedIndexChanged="ddlBudgetHeading_SelectedIndexChanged"   >
                                            <asp:ListItem Value="-1">-Select-</asp:ListItem>                                          
                                        </asp:DropDownList>
                                    </div>
                                      <div style="width: 15%; float: left;">
                                          <p>SubHeading<span style="color: red">*</span></p>
                                        <asp:DropDownList ID="ddlBudgetSubHeading"  CssClass="validate[required] TextBox" runat="server" AutoPostBack="True"  Width="80%" Height="25px">
                                            <asp:ListItem Value="-1">-Select-</asp:ListItem>                                          
                                        </asp:DropDownList>                                      
                                    </div>              
                                     <div style="width: 15%; float: left;">
                                    ...
                                    <div style="width: 15%; float: left;">
                                        <p>UOM<span style="color: red">*</span></p>               
                                       <asp:DropDownList runat="server" CssClass="validate[required] TextBox" ID="ddlUOM" Width="80%" Height="25px" >
                                           <asp:ListItem Value="-1">-Select-</asp:ListItem>
                                       </asp:DropDownList>
                                    </div>
                                     <div style="width: 15%; float: left;">
                                        <p>Rate(Unit)<span style="color: red">*</span></p>
                        ...
                        <div style="height: 60px; float: right; width: 100%; padding: 40px 40px 40px 40px;" class="divclasswithoutfloat">
                            <asp:Button runat="server" ID="btnSaveClass" Text="ADD" CssClass="btn-blue btn-blue-medium" OnClick="btnSaveClass_Click" OnClientClick="return ClearDatalist()"/>
                        </div>
