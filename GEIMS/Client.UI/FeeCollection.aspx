            ...
            $(".autosuggest").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        data: "{'prefixText':'" + request.term + "','SearchType':'" + $(document.getElementById('<%= ddlSearchBy.ClientID %>')).val() + "','SchoolMID':'" +<%=Session[ApplicationSession.SCHOOLID] %> + "','SectionType':'" + $(document.getElementById('<%= ddlSection.ClientID %>')).val() + "','ClassType':'" + $(document.getElementById('<%= ddlClassName.ClientID %>')).val() + "','DivisionType':'" + $(document.getElementById('<%= ddlDivisionName.ClientID %>')).val() + "'}",
                        dataType: "json",                       
                    ...
                    <div id="tabs-1" style="padding: 5px 5px 5px 5px;" class="gradientBoxesWithOuterShadows">
                            ...
                            <fieldset>
                                ...
                                <div class="divclasswithfloat" >   
                                    <div style="width: 15%; float: left;">
                                        <p>Section</p>                                      
                                        <asp:DropDownList runat="server" CssClass="validate[required] textarea" ID="ddlSection" Height="23px" Width="150px" AutoPostBack="True" OnSelectedIndexChanged="ddlSection_SelectedIndexChanged">
                                    ...
                                    <div style="width: 15%; float: left;">
                                        <p>Class</p>                                      
                                         <asp:DropDownList ID="ddlClassName"  CssClass="validate[required] textarea" runat="server" Height="23px" Width="150px" AutoPostBack="True" OnSelectedIndexChanged="ddlClassName_SelectedIndexChanged" >
                                            <asp:ListItem Value="-1">-Select-</asp:ListItem>                                          
                                        </asp:DropDownList>
                                    ...
                                    <div style="width: 25%; float: left;">
                                        <p>Division</p>
                                        <asp:DropDownList ID="ddlDivisionName"  CssClass="validate[required] textarea" runat="server" Height="23px" Width="150px">
                                            <asp:ListItem Value="-1">-Select-</asp:ListItem>                                          
                                        </asp:DropDownList>  
                                ...
                                <div class="divclasswithfloat">
                                    <div style="width: 80%; float: left;">
                                        <asp:DropDownList ID="ddlSearchBy" Height="23px" Width="150px" CssClass="validate[required] textarea" runat="server">
                                            <asp:ListItem Value="-1">-Select-</asp:ListItem>
                        ...
                        <div id="divFeePanel" runat="server">
                            <div class="divclasswithfloat">
                                ...
                                <asp:DropDownList ID="ddlModeOfPayment" runat="server"  Width="150px" CssClass="validate[required] Droptextarea" AutoPostBack="True" OnSelectedIndexChanged="ddlModeOfPayment_SelectedIndexChanged"  >
                                ...
                                Deposit In Bank:<span style="color: red">*</span>
                                <asp:DropDownList ID="DropDownList1" runat="server"  Width="150px" CssClass="validate[required] Droptextarea" AutoPostBack="True" OnSelectedIndexChanged="ddlModeOfPayment_SelectedIndexChanged"  >
                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                    <asp:ListItem Value="4">RTGS </asp:ListItem>
                                    <asp:ListItem Value="5"> NEFT</asp:ListItem>
                                    <asp:ListItem Value="6">DRAFT</asp:ListItem>
                                </asp:DropDownList>
                                Ledger Account:
                                  <asp:DropDownList ID="ddlBankList" runat="server"  Width="150px" CssClass="Droptextarea">
                            ...
                            <fieldset>
                                ...
                                <div class="divclasswithfloat">
							        ...
							        <div style="text-align: left; width: 30%; float: left;">
								         <asp:Label runat="server" ID="lblBudgetCategory"></asp:Label>
                               ...
                               <%-- <div class="divclasswithfloat">
							        ...
							        <div style="text-align: left; width: 35%; float: left;">
                                        <div style="text-align: left; width: 30%; float: left;">
								            <asp:Label runat="server" ID="lblUnutilizedBudget" Style="text-align:right;" Text="0"></asp:Label>                                        
							            </div>   
							       </div>
						        </div>--%>
                            </fieldset>
                                        ...
                                        <asp:GridView ID="gvFees" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="FeesType" HeaderText="Fees Category">
                                                 ...
                                                 <%--<asp:TemplateField HeaderText="Heading" FooterStyle-Font-Size="15px">
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="ddlBudgetHeading" runat="server" CssClass="Droptextarea"
                                                            Font-Names="Verdana" Font-Size="12px" Width="100px" OnSelectedIndexChanged="ddlBudgetHeading_SelectedIndexChanged" AutoPostBack="True">
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                    <FooterStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                                </asp:TemplateField>--%>
                                               <%-- <asp:TemplateField HeaderText="SubHeading" FooterStyle-Font-Size="15px">
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="ddlBudgetSubHeading" runat="server" CssClass="Droptextarea"
                                                            Font-Names="Verdana" Font-Size="12px" Width="100px" AutoPostBack="false" >
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                    <FooterStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                                </asp:TemplateField>--%>
