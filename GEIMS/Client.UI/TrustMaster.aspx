    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#<%= gvbankAssociation.ClientID %> input[id*='ConfirmDeleteCheckBox']").change(function () {
                ...
                if (isChecked == true) {
                    //commented on 27/09/2022 Bhandavi getting alert 1true when we click on check box
                    //alert("1" + isChecked);
                    ...
                    //commented on 27/09/2022 Bhandavi getting alert 2false when we click on check box
                    //alert("2" + isChecked);
                    var th = $("[id*=gvbankAssociation] th:contains('Delete')");
