<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="Employee.aspx.cs" Inherits="GEIMS.Client.UI.Employee" %>
        ...
        $(document).ready(function () {
           ...
           $(".autosuggest").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        url: "Employee.aspx/GetAllEmployeeNameForReport",
          ...
          <%-- $(".autosuggest").autocomplete({
            ...
            if (tab == "0") {
                ...
                $(document.getElementById('<%= tabs.ClientID %>')).tabs({ disabled: [1, 2, 3, 4, 5, 6,7] });
                $(document.getElementById('<%= tabs.ClientID %>')).tabs({ active: 0 });

                $(document.getElementById('<%= ddlSchool.ClientID %>')).empty();
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "Employee.aspx/LoadSchool",
                    data: "{'intTrustID':'" + <%=Session["TrustID"] %> + "'}",
                    dataType: "json",
                    success: function (data) {
                        var temp = $.parseJSON(data.d);

                        var optionhtml1 = '<option value="">' + "-Select-" + '</option>';
                        $(document.getElementById('<%= ddlSchool.ClientID %>')).append(optionhtml1);
                        $(document.getElementById('<%= ddlDepartment.ClientID %>')).append(optionhtml1);

                        $.each(temp, function (i) {

                            var optionhtml = '<option value="' +
                                temp[i].SchoolMID + '">' + temp[i].SchoolNameEng + '</option>';
                            $(document.getElementById('<%= ddlSchool.ClientID %>')).append(optionhtml);
                        });
                ...
                $(document.getElementById('<%= tabs.ClientID %>')).tabs({ disabled: [0, 1, 2, 4, 5, 6,7] });
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "Employee.aspx/LoadDocument",
                ...
                $(document.getElementById('<%= tabs.ClientID %>')).tabs({ disabled: [0, 1, 2, 3, 5, 6,7] });
                ...
                $(document.getElementById('<%= tabs.ClientID %>')).tabs({ disabled: [0, 1, 2, 3, 4, 6,7] });
            ...
            {
                $(document.getElementById('<%= btnGoToEmployee.ClientID %>')).hide();
                $(document.getElementById('<%= tabs.ClientID %>')).tabs("enable", 7);
                $(document.getElementById('<%= tabs.ClientID %>')).tabs({ disabled: [0, 1, 2,3, 4, 5,6] });
                $(document.getElementById('<%= tabs.ClientID %>')).tabs({ active: 7 });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                <div id="divGridPanel" runat="server" style="text-align: center; padding-top: 10px; padding-bottom: 10px; padding-right: 10px; width: 100%;">
                    ...
                    <asp:Button ID="btnGo" runat="server" CssClass="btn-blue Attach" Width="50px" Text="Go" CausesValidation="false"
                        OnClick="btnGo_Click" />
                        <asp:HiddenField ID="hfReportingTo" runat="server" />
                        <br />
                        <br />
                        <asp:HiddenField ID="hnFindEmpId" runat="server" />
                    ...
                    <div id="tabs" runat="server">
                        <div id="tab-panel" class="style-tabs" visible="true">
                            <ul>
                                ...
                                <li><a id="tabExtraRemarkDetail" href="#tabs-8">Remarks</a></li>
                            </ul>
                                        ...
                                        <div style="width: 30%; float: left; text-align: left;">
                                            ...
                                            <div style="width: 100%; float: left; padding-left: 20px" class="divclasswithfloat">
                                                ...
                                                <asp:Button runat="server" ID="btnShowModal" Text="Take Photo" OnClick="btnClickPhoto_Click"
                                                    CausesValidation="false" CssClass="btn-blue-new btn-blue-medium Detach" Visible="false" />
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <div id="tabs-2" style="padding: 5px 5px 5px 5px;" class="gradientBoxesWithOuterShadows">
                                <div style="width: 100%;">
                                    ...
                                    <div style="width: 100%;">
                                        <fieldset>
                                            <legend>Employee Work Detail</legend>
                                            <div style="width: 100%;" class="divclasswithfloat">
                                                <div style="text-align: left; width: 19%; float: left;" class="label">
                                                ...
                                                <div style="text-align: left; width: 31%; float: left;">
                                                    <asp:TextBox ID="txtDeptJoinDate" runat="server" CssClass="TextBox" Width="150px"></asp:TextBox>
                                    ...
                                    <div style="width: 100%;">
                                        <fieldset>
                                            ...
                                            <div style="width: 100%;" class="divclasswithfloat">
                                                ...
                                                <div style="text-align: left; width: 31%; float: left;">
                                                    <asp:TextBox ID="txtOrgDate" runat="server" CssClass="TextBox" Width="150px"></asp:TextBox>
                                            ...
                                            <div style="width: 100%;" class="divclasswithfloat">
                                                ...
                                                <div style="text-align: left; width: 81%; float: left;">
                                                    ...
                                                    <%--    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ErrorMessage="Please select appointment."
                                                        ControlToValidate="rblAppointmentType" runat="server" ForeColor="Red" Display="Dynamic" ValidationGroup="VG" />--%>
                                                </div>
                                            ...
                                            <div style="width: 100%;" class="divclasswithfloat">
                                                ...
                                                <div style="text-align: left; width: 31%; float: left;">
                                                    <asp:TextBox ID="txtAppointmentTypeCode" runat="server" CssClass="TextBox" Width="300px"></asp:TextBox>
                                            ...
                                            <div style="width: 100%;" class="divclasswithfloat">
                                                ...
                                                <div style="text-align: left; width: 31%; float: left;">
                                                    <asp:TextBox ID="txtRetirementDate" runat="server" CssClass="TextBox" Width="150px"></asp:TextBox>
                                                ...
                                                <div style="text-align: left; width: 31%; float: left;">
                                                    <asp:TextBox ID="txtTermRetireDate" runat="server" CssClass="TextBox" Width="150px"></asp:TextBox>
                                    ...
                                    <div style="width: 100%;">
                                        <fieldset>
                                            ...
                                            <div id="divUser" visible="false" style="width: 100%;">
                                                <div style="width: 100%;" class="divclasswithfloat">
                                                    <div style="text-align: left; width: 19%; float: left;" class="label">
                                                        Username :<span style="color: red">*</span>
                                                    </div>
                                                    <div style="text-align: left; width: 81%; float: left;">
                                                        <asp:TextBox ID="txtUserName" runat="server" CssClass="validate[required] TextBox" Width="150px"></asp:TextBox>
                                                ...
                                                <div style="width: 100%;" class="divclasswithfloat">
                                                    ...
                                                    <div style="text-align: left; width: 31%; float: left;">
                                                        <asp:TextBox ID="txtPassWord" runat="server" CssClass="validate[required] TextBox" Width="150px" TextMode="Password"></asp:TextBox>
                                                    </div>
                                                    <div style="text-align: left; width: 19%; float: left;" class="label">
                                                        Retype-Password :<span style="color: red">*</span>
                                                    </div>
                                                    <div style="text-align: left; width: 31%; float: left;">
                                                        <asp:TextBox ID="txtRePassword" runat="server" CssClass="validate[required, equals[ctl00_ContentPlaceHolder1_txtPassWord]] TextBox" Width="150px" TextMode="Password"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div id="divResign" style="width: 100%;">
                                                ...
                                                <div style="width: 100%;" class="divclasswithfloat">
                                                    ...
                                                    <div style="text-align: left; width: 81%; float: left;">
                                                        <asp:TextBox ID="txtLastWorkingDate" runat="server" CssClass="validate[required] TextBox" Width="150px"></asp:TextBox>
                                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender7"  runat="server" Format="dd/MM/yyyy" PopupButtonID="txtLastWorkingDate" TargetControlID="txtLastWorkingDate">
                                                        </ajaxToolkit:CalendarExtender>
                                                    </div>
                            ...
                            <div id="tabs-6" style="padding: 5px 5px 5px 5px;" class="gradientBoxesWithOuterShadows">
                                <div style="width: 100%;" class="divclasswithfloat">
                                    <div style="text-align: left; width: 21%; float: left;" class="label">
                            ...
                            <div id="tabs-7" style="height: 300px;padding: 5px 5px 5px 5px;" class="gradientBoxesWithOuterShadows">
                                <div style="width: 100%;">
                                    ...
                                    <div style="width: 100%; margin-top: 10px;text-align: right; height: 30px;">
                                            <button id="btnContinueEmpRemakrs" type="button" class="btn-blue-new btn-blue-medium Detach">Continue</button>
                            ...
                            <%--Remarks Tab Start--%>
                                  <div id="tabs-8" style="padding: 5px 5px 5px 5px;" class="gradientBoxesWithOuterShadows">
                                ...
                                <div style="width: 100%;" class="divclasswithfloat">
                                    ...
                                    <div style="text-align: left; width: 29%; float: left;">
                                         <asp:TextBox ID="txtRemakrsDate" runat="server" CssClass="validate[required] TextBox" Width="150px"></asp:TextBox>
                                         <ajaxToolkit:CalendarExtender ID="CalendarExtender8" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtRemakrsDate" TargetControlID="txtRemakrsDate">
                                                        </ajaxToolkit:CalendarExtender>
                                    </div>
                                   <%-- <div style="text-align: left; width: 21%; float: left;" class="label">
                                    ...
                                    <div style="text-align: left; width: 29%; float: right; vertical-align: top;">
                                          <asp:TextBox ID="txtRemakrs" runat="server" CssClass="validate[required] SmallTextArea" Width="30px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                                    </div>--%>
                                </div>
                                      <div style="width: 100%;" class="divclasswithfloat">
                                         <div style="text-align: left; width: 21%; float: left;" class="label">
                                        ...
                                        <div style="text-align: left; width: 29%; float: left; vertical-align: top;">
                                              <asp:TextBox ID="txtRemakrs" runat="server" CssClass="validate[required] TextArea" Width="256px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                    </div>
                          
                                <div style="width: 100%;" class="divclasswithfloat">
                                    <asp:GridView ID="gvEmpRemakrs" runat="server" AutoGenerateColumns="False"
                                        BorderColor="#3B5998" BorderWidth="3px" BorderStyle="Solid" CellPadding="4" GridLines="Both" OnRowCommand="gvEmpRemakrs_RowCommand"
                                        Font-Names="verdana" Font-Size="12px" Width="100%" BackColor="White">
                                        <FooterStyle BackColor="White" ForeColor="#333333" />
                                        <RowStyle BackColor="White" Height="20px" ForeColor="#333333" />
                                        <Columns>
                                            <asp:BoundField DataField="RemarksDate" HeaderText="Date">
                                                <HeaderStyle Width="300px" HorizontalAlign="left" VerticalAlign="Top" />
                                ...
                                <div style="width: 100%; text-align: right;" class="divclasswithoutfloat">
                                    <div style="text-align: right; width: 10%; float: right;">
                                        ...
                                        <asp:Button runat="server" ID="btnCancelEmpTRemakrs" Text="Cancel" CssClass="btn-blue btn-blue-medium Detach" OnClick="btnCancelEmpTRemakrs_Click" />
                                    </div>
                                    <div style="text-align: right; width: 90%; float: right;">
                                        <asp:Button runat="server" ID="bntAddEmpTRemakrs" Text="Add" CssClass="btn-blue-new btn-blue-medium Attach" OnClick="bntAddEmpTRemakrs_Click" />
                                    </div>
                                </div>
                                <div class="clear"></div>
                                <div style="width: 100%; text-align: right;" class="divclasswithoutfloat">
                                  
                                    <button id="btnBackEmpEmpRemakrs" type="button" class="btn-blue-back btn-blue-medium Detach" style="top: -35px;">Back</button>
                                </div>
    ...
    <script type="text/javascript">
        ...
        $(document.getElementById('<%= btnAddEmpExp.ClientID %>')).click(function () {
            $(document.getElementById('<%= txtCTC.ClientID %>')).addClass("validatecustom[onlyNumberSp]] ");
        ...
        $(document.getElementById('<%= ddlSchool.ClientID %>')).change(function () {
            $(document.getElementById('<%= ddlDepartment.ClientID %>')).empty();
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Employee.aspx/LoadDepartMent",
                data: "{'intTrustID':'" + <%=Session["TrustID"] %> + "','intSchoolID':'" + $('#<%= ddlSchool.ClientID %> option:selected').val() + "'}",
                dataType: "json",
                success: function (data) {
                    var temp = $.parseJSON(data.d);
                    var count = -1;
        ...
        $("#btnNextPersonal").click(function () {
            ...
            if (valid == true) {
                ...
                $(document.getElementById('<%= tabs.ClientID %>')).tabs({ disabled: [0, 2, 3, 4, 5, 6,7] });
        ...
        $("#btnForward").click(function () {
            ...
            $(document.getElementById('<%= txtCurPinCode.ClientID %>')).val($(document.getElementById('<%= txtCurPinCode.ClientID %>')).val());
        });
        ...
        $(function () {
            ...
            $("table[id*=rblAppointmentType]").validationEngine('attach', { promptPosition: "bottomRight" });
            $("table[id*=rblAppointmentType] input").addClass("validate[required]");
            $("[id*=btnNextPersonal]").bind("click", function () {
                if (!$("table[id*=rblAppointmentType]").validationEngine('validate')) {
                    return false;
                }
                return true;
            });
        ...
        $("#btnNextSchoolDetail").click(function () {
            ...
            if (valid == true) {
                ...
                $(document.getElementById('<%= tabs.ClientID %>')).tabs({ disabled: [0, 1, 3, 4, 5, 6,7] });
        ...
        $("#btnContinueEmpRemakrs").click(function () {
            $(document.getElementById('<%= tabs.ClientID %>')).tabs("enable", 7);
               $(document.getElementById('<%= tabs.ClientID %>')).tabs({ disabled: [0, 1, 2, 3,4, 5,6] });
               $(document.getElementById('<%= tabs.ClientID %>')).tabs({ active: 7 });
           });

        $("#btnBackEmpEmpRemakrs").click(function () {
            $(document.getElementById('<%= tabs.ClientID %>')).tabs("enable", 6);
                $(document.getElementById('<%= tabs.ClientID %>')).tabs({ disabled: [0, 1, 2, 3, 4, 5,7] });
            ...
            if ($(this).is(':checked')) {
                ...
                if (selectedValue == "0") {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        url: "Employee.aspx/LoadDepartMent",
                        data: "{'intTrustID':'" + <%=Session["TrustID"] %> + "','intSchoolID':'" + 0 + "'}",
                        dataType: "json",
                        success: function (data) {
                            var temp = $.parseJSON(data.d);
        ...
        $(document.getElementById('<%= btnCancelEmpTRemakrs.ClientID %>')).click(function () {
            $('#tabs-7 .TextBox').val('');
        });
        ...
        function viewForTrustandSchool() {
            $('#<%=rblSelect.ClientID%>').find('input[type=radio]').click(function () {
                //  alert("rblSelect");
                if ($(this).is(':checked')) {
                    var selectedValue = $(this).val();
