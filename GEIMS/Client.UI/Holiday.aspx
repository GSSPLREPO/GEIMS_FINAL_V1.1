<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="Holiday.aspx.cs" Inherits="GEIMS.Client.UI.Holiday" %>
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                ...
                <div id="tabs" runat="server">
					<div id="tab-panel" class="style-tabs" visible="true">
						<ul>
							<li><a id="tabClassDetails" href="#tabs-1">Holiday</a></li>
						</ul>
							...
							<div style="width: 100%;">
								...
								<div style="width: 100%" class="divclasswithfloat">
									...
									<div style="text-align: left; float: left; width: 80%;">
										<asp:DropDownList runat="server" CssClass="validate[required] TextBox" ID="ddlAcademicYear" Width="150px" Enabled="false" />
									</div>
								</div>
								<div style="width: 100%" class="divclasswithfloat">
									<div style="text-align: left; width: 20%; float: left;" class="label">
								...
								<div style="width: 100%" class="divclasswithfloat">
									...
									<div style="text-align: left; float: left; width: 80%;">
										 <asp:TextBox ID="txtDescription" runat="server"  Width="50%"  TextMode="MultiLine"></asp:TextBox>
									</div>
								</div>
