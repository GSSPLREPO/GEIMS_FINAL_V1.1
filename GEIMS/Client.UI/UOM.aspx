<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="UOM.aspx.cs" Inherits="GEIMS.Client.UI.UOM" %>
    ...
    <div id="divMain" style="width: 100%; text-align: left; padding-top: 5px;">
		...
		<div id="divContent" style="height: 100%; font-family: Verdana;">
			<script type="text/javascript">
			    $(function () {
			        $('#id_search').quicksearch('table#<%=gvUOM.ClientID%> tbody tr');
			    })
            </script>
			...
			<div id="divContent2" style="width: 80%; float: left; height: 100%;">
				...
				<div id="divGrid" runat="server" style="text-align: center; padding-top: 10px; padding-bottom: 10px; padding-right:10px; width: 100%;">
                    ...
                    <div style="text-align: center; padding-top: 10px; padding-bottom: 10px; width: 100%;">
                        <asp:GridView ID="gvUOM" runat="server" AutoGenerateColumns="False"
                            BorderColor="#3B5998" BorderWidth="3px" BorderStyle="Solid" CellPadding="4" GridLines="Both"
                            Font-Names="verdana" Font-Size="12px" Width="100%" BackColor="White" OnRowCommand="gvUOM_RowCommand"
                            OnPreRender="gvUOM_PreRender">
                            <FooterStyle BackColor="White" ForeColor="#333333" />
                            <RowStyle BackColor="White" Height="20px" ForeColor="#333333" />
                            <Columns>
                                <asp:BoundField DataField="UOMName" HeaderText="Unit Name" HeaderStyle-HorizontalAlign="Center" 
                                ...
                                <asp:TemplateField HeaderText="Edit" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ImageButton3" runat="server" CausesValidation="false" ImageUrl="~/Images/Edit.png"
                                            CommandName="Edit1" CommandArgument='<%# Eval("UOMID")%>' Height="20px" Width="20px" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Delete" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="false" ImageUrl="~/Images/delete-1.png"
                                            CommandName="Delete1" CommandArgument='<%# Eval("UOMID")%>' OnClientClick="javascript:return confirm('Are you sure, you want to delete this Record?');"
				...
				<div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
					<ul>
						<li><a id="tabMaterialGroupDetails" href="#tabs-1">UOM Details</a></li>
					</ul>
						...
						<div style="width: 100%; float: left;">
							<div style="height: 30px; margin-top: 10px; width: 100%;">
								...
								<div style="text-align: left; float: left; width: 80%;">
									<asp:TextBox ID="txtUnitName" runat="server" CssClass="validate[required] TextBox" Width="300px" Height="100%"></asp:TextBox>
								</div>
							</div>
