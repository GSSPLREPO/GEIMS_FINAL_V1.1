...
namespace GEIMS.Client.UI
{
    ...
    {
        private static ILog logger = LogManager.GetLogger(typeof(DesignationMaster));
        ...
        protected void btnSaveClass_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                objDesignationBO.FullDayWorkingHours = TxtFullDayWH.Text.Trim();
                ...
                if (e.CommandName.ToString() == "Edit1")
                {
                    ...
                    if (objResult != null)
                    {
                        ...
                        if (dtResult.Rows.Count > 0)
                        {
                            ...
                            TxtFullDayWH.Text = dtResult.Rows[0][DesignationBO.DESIGNATION_FULLDAYWORKINGHOURS].ToString();
                            PanelVisibility(2);
                        }
                    }
                }
