<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="Panelty.aspx.cs" Inherits="GEIMS.Library.Panelty" %>
		...
		<div id="divContent" style="height: 100%; font-family: Verdana;">
			...
			<div id="divContent2" style="width: 80%; float: left; height: 100%;">
				...
				<div id="tabss" runat="server" class="style-tabs" visible="true" style="width: 100%;">
					<ul>
						<li><a id="tabStudentTemplateDetails" href="#tabs-1">Book Penalty</a></li>
					</ul>
					<div id="tabs-1" style="padding:0 0 0 10px" class="gradientBoxesWithOuterShadows">
						...
						<div class="divclasswithfloat">
							...
							<div style="text-align: left; width: 15%; float: left;" class="label">
								Members Type :<span class="Required">*</span>
							</div>
							<div style="text-align: left; width: 35%; float: left;">
						...
						<div class="divclasswithfloat">
							...
							<div style="text-align: left; width: 15%; float: left;" class="label">
								Duration for Applicability: 
							</div>
							<div style="text-align: left; width: 35%; float: left;">
								<asp:DropDownList ID="ddlDurationApplicability"  CssClass="Droptextarea" runat="server" AutoPostBack="True">
                                    <asp:ListItem Value="-1">-Select-</asp:ListItem>  
									<asp:ListItem Value="1">10</asp:ListItem> 
									<asp:ListItem Value="2">15</asp:ListItem> 
									<asp:ListItem Value="3">30</asp:ListItem> 
									<asp:ListItem Value="4">45</asp:ListItem> 
									<asp:ListItem Value="5">60</asp:ListItem> 
								</asp:DropDownList>
							</div>
						</div>
						...
						<div class="divclasswithoutfloat">
							<asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn-blue-new btn-blue-medium" style="left: -8px; top: -3px" />
						</div>
						<%--</fieldset>--%>
					</div>
				</div>
