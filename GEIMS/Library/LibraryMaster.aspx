<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="LibraryMaster.aspx.cs" Inherits="GEIMS.Library.LibraryMaster" %>
		...
		<div id="divContent" style="height: 100%; font-family: Verdana;">
			...
			<div id="divContent2" style="width: 80%; float: left; height: 100%;">
				...
				<div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
					<ul>
						<li><a id="tabStudentTemplateDetails" href="#tabs-1">Book Entry</a></li>
					</ul>
					<div id="tabs-1" style="padding:0 0 0 10px" class="gradientBoxesWithOuterShadows">
						...
						<div class="divclasswithfloat">
							...
							<div style="text-align: left; width: 15%; float: left;" class="label">
								ISBN No :<span class="Required">*</span>
							</div>
							<div style="text-align: left; width: 35%; float: left;">
								<asp:TextBox runat="server" ID="txtISBNCode" CssClass="TextBox detach" Width="190px" BackColor="#cae4ff"></asp:TextBox>
							</div>
						</div>
						<div class="divclasswithfloat">
							<div style="text-align: left; width: 15%; float: left;" class="label">
						...
						<div class="divclasswithfloat">
							...
							<div style="text-align: left; width: 35%; float: left;">
								 <asp:TextBox runat="server" ID="txtBookName" CssClass="TextBox detach" Width="190px" Style="text-align:right;" ></asp:TextBox>
							</div>
							<div style="text-align: left; width: 15%; float: left;" class="label">
								Author Name :
							</div>
							<div style="text-align: left; width: 35%; float: left;">
								<asp:TextBox runat="server" ID="txtAuthorName" CssClass="TextBox detach" Width="190px" Style="text-align:right;" ></asp:TextBox>
							</div>
						</div>
						<div class="divclasswithfloat">
							<div style="text-align: left; width: 15%; float: left;" class="label">
