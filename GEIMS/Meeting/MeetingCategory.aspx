<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="MeetingCategory.aspx.cs" Inherits="GEIMS.Meeting.MeetingCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        $(function () {
            $('#id_search').quicksearch('table#<%=gvMeetingCategory.ClientID%> tbody tr');
         })
    </script>
        ...
        <div id="divContent" style="height: 100%; font-family: Verdana;">
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                <div id="divGrid" runat="server" style="text-align: center; padding-top: 10px; padding-bottom: 10px; padding-right: 10px; width: 100%;">
                    ...
                    <br />
                    <asp:GridView ID="gvMeetingCategory" runat="server" AutoGenerateColumns="False"
                        BorderColor="#3B5998" BorderWidth="3px" BorderStyle="Solid" CellPadding="4"
                        Font-Names="verdana" Font-Size="12px" Width="100%" BackColor="White" OnRowCommand="gvMeetingCategory_RowCommand">
                        <FooterStyle BackColor="White" ForeColor="#333333" />
                        <RowStyle BackColor="White" Height="20px" ForeColor="#333333" />
                        <Columns>
                               <asp:BoundField DataField="CategoryName" HeaderText="Meeting Cateogry Name">
                            ...
                            <asp:BoundField DataField="CategoryDescription" HeaderText="Meeting Description">
                            ...
                            <asp:TemplateField HeaderText="Edit">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageButton3" runat="server" CausesValidation="false" ImageUrl="~/Images/Edit.png"
                                        CommandName="Edit1" CommandArgument='<%# Eval("CategoryID")%>' Height="20px" Width="20px" />
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Delete">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="false" ImageUrl="~/Images/delete-1.png"
                                        CommandName="Delete1" CommandArgument='<%# Eval("CategoryID")%>' OnClientClick="javascript:return confirm('Are you sure, you want to delete this Record?');"
                ...
                <div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
                    <ul>
                        <li><a id="tabClassDetails" href="#tabs-1">Meeting Category</a></li>
                    </ul>
                        ...
                        <div style="width: 100%;">
                            <div class="divclasswithfloat">
                                ...
                                <div style="text-align: left; width: 30%; float: left;">
                                   <asp:TextBox ID="txtCategoryName" runat="server" onKeyUp="CheckTextLength(this,50)" onkeypress="return charCategory(event);" CssClass="validate[required] TextBox" Width="150%"></asp:TextBox>
                                </div>
                            </div>
