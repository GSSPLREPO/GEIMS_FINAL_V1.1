<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptPnL.aspx.cs" MasterPageFile="~/Master/TrustMain.Master" Inherits="GEIMS.Accounting.RptPnL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%--<script type="text/javascript">
        $(function () {
            $('#id_search').quicksearch('table#<%=gvDayBookReport.ClientID%> tbody tr');
        })
    </script>--%>
                            ...
                            <div style="text-align: left; width: 50%; float: left; padding: 2px;" class="label">
                                <asp:GridView ID="gvIncome" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="AccountGroupName" HeaderText="Income Account Group">
                            ...
                            <div style="text-align: left; width: 48%; float: left; padding: 2px;">
                                <asp:GridView ID="gvExpense" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="AccountGroupName" HeaderText="Expense Account Group">
                                            <HeaderStyle Width="85%" HorizontalAlign="Center" VerticalAlign="Top" />
                                            <ItemStyle HorizontalAlign="left" Width="85%" VerticalAlign="Top" Wrap="true" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="Sequence">
                ...
                <div id="divGrid" runat="server" style="text-align: center; padding-top: 10px; padding-bottom: 10px; width: 100%;">
                    ...
                    <%--<div class="divclasswithfloat">
                        <div style="text-align: left; width: 1070px; float: left;">
                            <asp:GridView ID="gvDayBookReport" runat="server" AutoGenerateColumns="False"
                                BorderColor="#3B5998" BorderWidth="3px" BorderStyle="Solid" CellPadding="4" GridLines="Both" ShowFooter="True"
                                Font-Names="verdana" Font-Size="12px" Width="100%" BackColor="White">
                                <FooterStyle BackColor="White" ForeColor="#333333" />
                                <RowStyle BackColor="White" Height="20px" ForeColor="#333333" />
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="AccountName" HeaderText="Particulars">
                    ...
                    <div style="text-align: center;">
                        <div id="div3" style="font-family: Verdana; font-size: 9px; text-align: center; width: 100%; float: left;"
                            class="">
                            <asp:DataList ID="dlIncomeExpenditureAccount" runat="server" RepeatDirection="Horizontal" Visible="False"
                                OnItemDataBound="dlIncomeExpenditureAccount_OnItemDataBound" Height="100%" Width="1050px" HorizontalAlign="Center">
                                <ItemTemplate>
                                    <table style="font-family: Verdana; font-size: 10px; text-align: center; font-weight: normal; width:500px; float: left"
                                    ...
                                    Font-Names="verdana" Font-Size="12px" Width="100%" BackColor="White">
                                     ...
                                     <%--   Expense Table--%>
                                        <tr>  
                                            <td>
                                                <table style="font-family: Verdana; font-size: 10px; font-weight: normal; width: 500px; float: left" 
                                                    cellspacing="0px" cellpadding="1px">
                                                    <tr>
                                                        <td align="left">
                                                            <asp:DataList ID="dlExpenseTransaction" runat="server" RepeatDirection="Vertical" OnItemDataBound="dlExpenseTransaction_OnItemDataBound"
                                                                ...
                                                                <HeaderTemplate>
                                                                    <table width="100%" style="font-family: Verdana; font-size: 13px; font-weight: bold;">
                                                                        <%--<tr>--%>
                                                                            ...
                                                                            <td align="center" style="border:1px solid black;width:15px">
                                                                                <b></b>
                                                                            </td>
                                      ...
                                      <%--  Income Table--%>
                                            ...
                                            <td>
                                                    <table style="font-family: Verdana; font-size: 10px; font-weight: normal; width: 500px; float: left"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:DataList ID="dlIncomeTransaction" runat="server" RepeatDirection="Vertical" onItemDataBound="dlIncomeTransaction_OnItemDataBound"
                                                                     Height="100%" Width="100%" HorizontalAlign="Center">
                                                                    <HeaderTemplate>
                                                                        <table width="100%" style="font-family: Verdana; font-size: 13px; font-weight: bold;">
                                                                            <tr>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var gvIncomeRowsCount = $('#<%=gvIncome.ClientID %> tr').length;
            var gvExpenseRowsCount = $('#<%=gvExpense.ClientID %> tr').length;
            var oldVal;

            $('#<%=gvIncome.ClientID %>').find("input:text").click(function () {
                oldVal = $(this).val();
            });
            ...
            $('[id$=txtSequence]').change(function () {
                ...
                if (newVal != '' && newVal != 0 && newVal != null && newVal < gvIncomeRowsCount && newVal > 0) {
                    ...
                    $('#<%=gvIncome.ClientID %> tr').each(function () {
            ...
            var oldValExp;
            $('#<%=gvExpense.ClientID %>').find("input:text").click(function () {
                oldValExp = $(this).val();
            });
            ...
            $('[id$=txtSequence1]').change(function () {
                ...
                if (newValExp != '' && newValExp != 0 && newValExp != null && newValExp < gvExpenseRowsCount && newValExp > 0) {
                    $('#<%=gvExpense.ClientID %> tr').each(function () {
