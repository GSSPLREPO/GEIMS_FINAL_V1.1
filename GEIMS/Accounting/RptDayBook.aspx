<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="RptDayBook.aspx.cs" Inherits="GEIMS.Accounting.RptDayBook" %>
				...
				<div id="divGrid" runat="server" style="text-align: center; padding-top: 10px; padding-bottom: 10px; width: 100%;">
					...
					<div class="divclasswithfloat">
						<div style="text-align: left; width: 1070px; float: left;">
							<asp:GridView ID="gvDayBookReport" runat="server" AutoGenerateColumns="False" OnPreRender="gvDayBookReport_OnPreRender"
								BorderColor="#3B5998" BorderWidth="3px" BorderStyle="Solid" CellPadding="4" GridLines="Both" ShowFooter="False"
								Font-Names="verdana" Font-Size="12px" Width="100%" BackColor="White" OnRowDataBound="gvDayBookReport_RowDataBound">
