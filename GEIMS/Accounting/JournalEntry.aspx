				...
				<div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
					...
					<div id="tabs-1" style="padding:0 0 0 10px" class="gradientBoxesWithOuterShadows">
						...
						<div class="divclasswithfloat">
							...
							<div style="text-align: left; width: 35%; float: left;">
								<asp:DropDownList ID="ddlSection"  CssClass="Droptextarea" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSection_SelectedIndexChanged"  >
						...
						<div class="divclasswithfloat">
							...
							<div style="text-align: left; width: 35%; float: left;">
								<asp:DropDownList ID="ddlBudgetSubHeading"  CssClass="Droptextarea" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlBudgetSubHeading_SelectedIndexChanged"    >
                                      <asp:ListItem Value="-1">-Select-</asp:ListItem>                                          
                                </asp:DropDownList>   
						...
						<div class="divclasswithoutfloat">
							<asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn-blue-new btn-blue-medium" OnClick="btnSave_Click" OnClientClick="return(confirm('Check this Entry to Connected Budget?'))" style="left: -8px; top: -3px" />
						</div>
						<%--</fieldset>--%>
					</div>
				</div>
