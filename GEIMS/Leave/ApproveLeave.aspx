<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="ApproveLeave.aspx.cs" Inherits="GEIMS.Leave.ApproveLeave" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <asp:GridView ID="gvLeaveApprove" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Approve">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageButton3" runat="server" CausesValidation="false" ImageUrl="~/Images/Status.png"
                                        CommandName="Approve1" CommandArgument='<%# Eval("LeaveApplyID")%>' Height="20px" Width="20px" OnClientClick="javascript:return confirm('Are you sure,You want to approve leave?');" />
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Change">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="false" ImageUrl="~/Images/changes.png"
                                        CommandName="Edit1" CommandArgument='<%# Eval("LeaveApplyID")%>' OnClientClick="javascript:return confirm('Are you sure,You Want to Edit Approved Leave?');"
                    ...
                    <div id="div1" runat="server" style="text-align: center; padding-top: 10px; padding-bottom: 10px; padding-right: 10px; width: 100%;">
                        <asp:GridView ID="gvLeave" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Approve Leave">
                                     <HeaderTemplate>
                                         <asp:CheckBox ID="chkHeader" runat="server" Width="5px" />
                                     </HeaderTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Half Day?">
                                    <ItemTemplate>
                                       <%-- <asp:CheckBox ID="cbHalfDay" runat="server"
                                            Font-Names="Verdana" Font-Size="12px" Width="50px" style="background-color:#3B5998; border:none;  display:initial;" ></asp:CheckBox>--%>
                                         <asp:CheckBox ID="cbHalfDay" runat="server"
                                            Font-Names="Verdana" Font-Size="12px" Width="50px" style="background-color:#3B5998; border:none;  display:initial;" ></asp:CheckBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                        ...
                        <div id="divReason" runat="server" style="padding-top: 20px" >
                            <div style="text-align: left; width: 20%; float: left;" class="label">
                                <%--Reject--%> Reason :<%--<span style="color: red">*</span>--%></div>
                            <div style="text-align: left; float: left; width: 80%; margin-bottom: 15px;">
    ...
    <script type="text/javascript">
        ...
        $("[id*=cbApprove]").click(function () {
            ...
            if ($('[id*=cbApprove]').length == $('[id*=cbApprove]:checked').length) {
                   //alert("In");
            ...
            if ($('[id*=cbApprove]').length == $('[id*=cbApprove]:not(:checked)').length) {
                 $(document.getElementById('<%= btnSave.ClientID %>')).prop("disabled", true);
                $(document.getElementById('<%= btnSave.ClientID %>')).css("background-color", "#848484");
            }
        });
