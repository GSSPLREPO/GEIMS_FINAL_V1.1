<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="SchoolApproveLeave.aspx.cs" Inherits="GEIMS.Leave.SchoolApproveLeave" %>
        ...
        <div id="divContent" style="height: 100%; font-family: Verdana;">
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                            ...
                            <asp:TemplateField HeaderText="Approve">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageButton3" runat="server" CausesValidation="false" ImageUrl="~/Images/Status.png"
                                        CommandName="Approve1" CommandArgument='<%# Eval("LeaveApplyID")%>' Height="20px" Width="20px" OnClientClick="javascript:return confirm('Are you sure,You want to approve/reject leave?');" />
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Change">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="false" ImageUrl="~/Images/changes.png"
                                        CommandName="Edit1" CommandArgument='<%# Eval("LeaveApplyID")%>' OnClientClick="javascript:return confirm('Are you sure,Not approve leave?');"
                ...
                <asp:Panel ID="pnlApproveLeave" runat="server" GroupingText="Approve Leave">
                    ...
                    <br />
                    <p style="color:red;"> 
                        Rule1 : Approved: If Check box is checked so Leave is Approved.<br />
                        Rule2 : Reject : If check box is Not checked so Leave is Rejected.
                    </p>
                    <br/>
                    <div id="div1" runat="server" style="text-align: center; padding-top: 10px; padding-bottom: 10px; padding-right: 10px; width: 100%;">
                        ...
                        <div id="divReason" runat="server" style="padding-top: 20px">
                         ...
                         <div id="divApproved" runat="server" style="padding-top: 20px;">
                            <div style="text-align: left; width: 20%; float: left; margin-top:10px;" class="label">
                            ...
                            <div style="text-align: left; float: left; width: 80%;">
                              <%--  <asp:TextBox ID="txtApprovedDate" runat="server" CssClass="validate[required] TextBox" Width="150px" Height="100%" TextMode="Date"></asp:TextBox>--%>
                                <asp:TextBox ID="txtApprovedDate" runat="server" CssClass="validate[required] TextBox"
                                            Font-Names="Verdana" Height="13px" onblur="howManyDecimals(this.id,'#FFFFFF')" onkeypress="return NumericKeyPressFraction(event)" Style="text-align: right; margin-top:10px;" Width="110px"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" Enabled="True"
