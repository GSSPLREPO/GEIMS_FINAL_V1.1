<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="ApplyDutyLeave.aspx.cs" Inherits="GEIMS.Leave.DutyLeave.ApplyDutyLeave" %>
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                ...
                <div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
                    ...
                    <div id="tabs1" style="min-height: 150px;" runat="server">
                        ...
                        <asp:Panel ID="pnlStudentInfo" runat="server" GroupingText="Apply For Duty Leave">
                                ...
                                <div style="width: 100%; float: right; padding-top: 0px;" class="label">
                                    <div style="padding: 10px; padding-right: 30px;">
                                        <div style="float: left; text-align: right; width: 100%; padding-bottom: 10px;">
                                            <asp:Button runat="server" ID="btnApplyLeave" Text="Apply Duty Leave" CssClass="btn-blue-new btn-blue-medium" OnClick="btnApplyLeave_OnClick" />
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImageButton3" runat="server" CausesValidation="false" ImageUrl="~/Images/delete-1.png"
                                                    CommandName="Delete1" CommandArgument='<%# Eval("DutyLeaveApplyID")%>' Height="20px" Width="20px" CssClass="detach" OnClientClick="javascript:return confirm('Are you sure,You want to approve leave?');" />
                                            </ItemTemplate>
                            ...
                            <div id="divGrid" runat="server" style="text-align: center; padding-top: 10px; padding-bottom: 10px; padding-right: 10px; width: 100%;">
                                <div id="div1" runat="server" style="text-align: center; padding-top: 10px; padding-bottom: 10px; padding-right: 10px; width: 100%;">
                                    <br />
                                    <asp:GridView ID="gvLeaveBalance" runat="server" AutoGenerateColumns="False" Visible="false" 
                                        ...
                                        <asp:TemplateField HeaderText="Half Day?">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="cbHalfDay" runat="server"
                                                    Font-Names="Verdana" Font-Size="12px" Width="50px" Enabled="false"></asp:CheckBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
