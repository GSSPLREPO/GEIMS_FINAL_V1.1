...
{
    public partial class SchoolApproveDutyLeave : System.Web.UI.Page
    {
        private static ILog logger = LogManager.GetLogger(typeof(SchoolApproveDutyLeave));
            ...
            try
            {
                ...
                if (ViewState["Mode"].ToString() == "Approve")
                {
                    ...
                    if (a == b)
                    {
                        ...
                        //objLeaveTemplateBo.CreatedBy = Convert.ToInt32(ViewState["EmployeeMID"].ToString());  //Error
        ...
        public void LeaveApplyBind_Applied()
        {
            ...
            //objResult = objLeaveApplyBl.DutyLeaveApply_Select_ForPrincipal(Convert.ToInt32(ddlStatus.SelectedValue), Convert.ToInt32(Session[ApplicationSession.USERID]));
            objResult = objLeaveApplyBl.DutyLeaveApply_Select_ForPrincipal(Convert.ToInt32(0), Convert.ToInt32(Session[ApplicationSession.USERID]));
            if (objResult != null)
            {
        ...
        public void LeaveApplyBind_Approved()
        {
            ...
            //objResult = objLeaveApplyBl.DutyLeaveApply_Select_ForPrincipal(Convert.ToInt32(ddlStatus.SelectedValue), Convert.ToInt32(Session[ApplicationSession.USERID]));
            objResult = objLeaveApplyBl.DutyLeaveApply_Select_ForPrincipal(Convert.ToInt32(1), Convert.ToInt32(Session[ApplicationSession.USERID]));
            if (objResult != null)
            {
                if (objResult.resultDT.Rows.Count > 0)
                {
