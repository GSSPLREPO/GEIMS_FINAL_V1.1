<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="FeeCollectionSchoolWise.aspx.cs" Inherits="GEIMS.ReportUI.FeeCollectionSchoolWise" %>
                            ...
                            <div style="width: 100%; float: left;" class="label">
                                <div style="padding: 10px;">
                                    ...
                                    <div style="float: left; width: 85%;">
                                        <asp:DropDownList ID="ddlSchool" runat="server" CssClass="Droptextarea" Width="260px" AutoPostBack="true" OnSelectedIndexChanged="ddlSchool_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </div>
