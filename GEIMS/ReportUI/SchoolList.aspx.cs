...
{
    public partial class SchoolList : PageBase
    {
        ...
        protected void btnExportPDF_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=SchoolList" + "_" + DateTime.Now.Date.ToString("yyyy-mm-dd") +".pdf");
        ...
        protected void btnExportExcel_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=SchoolList" + "_" + DateTime.Now.Date.ToString("yyyy-mm-dd") +".xls");
                Response.Charset = "";
               ...
               gvReport.AllowPaging = false;
                ...
                string content = "<div align='center' style='font-family:verdana;font-size:13px'>" +
                    //"<div ><img height = '80' width = '100' src = '" + strPath + "' /></div>" +
                    "<table><tr><td><img height = '80' width = '100' src = '" + strPath + "' /></td></tr></table>" +
                
                    "<span style='font-size:16px:font-weight:bold;color:Maroon;'>Report : School List" +
                    "</span><br/><span style='font-size:13px:font-weight:bold'></span><br/><span align='center' style='font-family:verdana;font-size:11px'>" +
                    "<strong>Date :</strong>" + System.DateTime.Now.ToShortDateString() + "</span><br/>" +
                    "<span align='center' style='font-family:verdana;font-size:11px'><strong>Trust Name :</strong>" +
                    Session[ApplicationSession.TRUSTNAME].ToString() + "</span><br/><br/><br/> " + sw.ToString() + "<br/>";
                Response.Output.Write(content);
        ...
        protected void btnExportWord_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=SchoolList" + "_" + DateTime.Now.Date.ToString("yyyy-mm-dd") +".doc");
                Response.Charset = "";
                ...
                string content = "<div align='center' style='font-family:verdana;font-size:13px'><span style='font-size:16px:font-weight:bold;color:Maroon;'>Report : School List</span><br/><span style='font-size:13px:font-weight:bold'></span><br/><span align='center' style='font-family:verdana;font-size:11px'><strong>Date :</strong>" + System.DateTime.Now.ToShortDateString() + "</span><br/><span align='center' style='font-family:verdana;font-size:11px'><strong>Trust Name :</strong>" + Session[ApplicationSession.TRUSTNAME].ToString() + "</span><br/><br/><br/> " + sw.ToString() + "<br/>";
                Response.Output.Write(content);
