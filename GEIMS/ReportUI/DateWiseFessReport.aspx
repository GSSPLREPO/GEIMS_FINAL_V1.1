<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="DateWiseFessReport.aspx.cs" Inherits="GEIMS.ReportUI.DateWiseFessReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="divMain" style="width: 100%; text-align: left; padding-top: 5px;">
        <div id="divTitle" class="pageTitle" style="width: 100%;">
            Date Wise Student fees Collection
                        ...
                        ToolTip="Export to Word" OnClick="btnExportWord_Click" />
                            ...
                            <div style="padding: 10px; padding-right: 30px;  overflow: scroll;width: 100%; float: left">
                                ...
                                <asp:GridView ID="gvReport" Visible="true" runat="server" BackColor="White" BorderColor="Black" AutoGenerateColumns="True"
                                    CellPadding="3" Font-Names="Verdana" Font-Size="11px" AllowSorting="false" Width="100%">
