...
namespace GEIMS.ReportUI
{
    ...
    public partial class FeeCollectionSchoolWise : PageBase
    {
        private static ILog logger = LogManager.GetLogger(typeof(FeeCollectionSchoolWise));
        ...
        public void getSchoolName()
        {
            ...
            if (objResult != null)
            {
                ...
                ddlSchool.Items.Insert(0, new System.Web.UI.WebControls.ListItem("--Select All--", ""));
            }
        }
        #endregion
        ...
        public void BindAcademicYear()
        {
            try
            {
                #region Fetch Academic Month from School
                 int intMonth = 0;
                if (ddlSchool.SelectedValue != "" || ddlSchool.SelectedValue == "-1")
                {
                    SchoolBL objSchoolBl = new SchoolBL();
        ...
        #region ddlSchool SelectedIndexChanged
        ...
        protected void btnExportPDF_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=FeeCollectionSchoolWise" + "_" + DateTime.Now.Date.ToString("yyyy-MM-dd") + ".pdf");
        ...
        protected void btnExportExcel_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename= FeeCollectionSchoolWise" + "_" + DateTime.Now.Date.ToString("yyyy-MM-dd") + ".xlsx");
                Response.Charset = "";
        ...
        protected void btnExportWord_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=FeeCollectionSchoolWise" + "_" + DateTime.Now.Date.ToString("yyyy-MM-dd") + ".doc");
                Response.Charset = "";
        ...
        public void BindSchoolFeesList()
        {
            ...
            if (ddlSchool.SelectedValue == "-1" || ddlSchool.SelectedValue == "")
            {
                objResult = objFeesCollectionBl.FeesCollection_Select_byYearlySchoolWise(Convert.ToInt32(Session[ApplicationSession.TRUSTID]), 0, ddlYear.SelectedItem.Text);
               
            }
            else
            {
                objResult = objFeesCollectionBl.FeesCollection_Select_byYearlySchoolWise(Convert.ToInt32(Session[ApplicationSession.TRUSTID]), Convert.ToInt32(ddlSchool.SelectedValue), ddlYear.SelectedItem.Text);
            }
            if (objResult.resultDT.Rows.Count > 0)
            {
        ...
        {
            Response.Redirect("../Client.UI/TrustReports.aspx?Mode=FeesReport");
        }
        #endregion
    }
}