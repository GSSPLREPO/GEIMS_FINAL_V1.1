...
{
    public partial class FeesCollectionSchoolWiseForSchool : PageBase
    {
        private static ILog logger = LogManager.GetLogger(typeof(FeesCollectionSchoolWiseForSchool));
        ...
        protected void btnExportExcel_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                // gvReport.AllowPaging = false;
                // gvReport.RenderControl(hw);
                //// string strTitle = "પોલીસ કમિશ્‍નર ની કચેરી, વડોદરા શહેર";
                //// string strSubTitle = lblTitle.Text;
                // string Date = DateTime.UtcNow.AddHours(5.5).ToString();
                //// string content =
                // //    "<div align='center'><div><div style='font-size:16px:font-weight:bold;color:Maroon'><span>" +
                // //    strTitle + "</span></div></div><span>" + strSubTitle +
                // //    "</span></div><div align='right' style='font-family:verdana;font-size:11px'><strong>Date :</strong>" +
                //  //   Date +
                //  //   "</div><div class=Section1><div align='left' style='font-family:verdana;font-size:13px;border-style: solid; border-width: thin;'>" +
                //  //   sw + "</div> </div>";
        ...
        public void BindSchoolFeesList()
        {
            ...
            objResult = objFeesCollectionBl.FeesCollection_Select_byYearlySchoolWise(Convert.ToInt32(Session[ApplicationSession.TRUSTID]), Convert.ToInt32(Session[ApplicationSession.SCHOOLID]), ddlYear.SelectedItem.Text);
