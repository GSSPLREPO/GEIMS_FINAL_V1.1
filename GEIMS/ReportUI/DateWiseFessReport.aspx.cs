...
{
    public partial class DateWiseFessReport : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click1(object sender, System.EventArgs e)
        {
        ...
        protected void btnBack_Click1(object sender, System.EventArgs e)
        {
            ClearAll();
        }
        #endregion
        ...
        protected void btnExportPDF_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                string content = "<div align='center' style='font-family:verdana;font-size:13px'>" +
                                 "<span style='font-size:16px:font-weight:bold;color:Maroon;'>DateWise FeesCollection Report</span><br/><span style='font-size:13px:font-weight:bold'></span>" +
                                 ...
                                 "<span align='center' style='font-family:verdana;font-size:11px'><strong></strong></span><br/><br/><br/><br/><br/>" + "" + sw.ToString() +
                                 "<br/>";
        ...
        protected void btnExportExcel_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                string content = "<div align='center' style='font-family:verdana;font-size:13px'><span style='font-size:16px:font-weight:bold;color:Maroon;'>DateWise FeesCollection Report</span><br/><br/><span style='font-size:13px:font-weight:bold'></span><br/><br/><div align='center' style='font-family:verdana;font-size:11px'><strong>Date :</strong>" + System.DateTime.Now.ToShortDateString() + "</div><br/><div align='center' style='font-family:verdana;font-size:11px'><strong>School Name :</strong>" + Session[ApplicationSession.SCHOOLNAME].ToString() + "</div><br/><div align='center' style='font-family:verdana;font-size:11px'></div><br/><div align='center' style='font-family:verdana;font-size:11px'></div><br/><div align='center' style='font-family:verdana;font-size:11px'></div><br/><strong></strong></div>" +
        ...
        protected void btnExportWord_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                string content = "<div align='center' style='font-family:verdana;font-size:13px'><span style='font-size:16px:font-weight:bold;color:Maroon;'>DateWise FeesCollection Report</span><br/><br/><span style='font-size:13px:font-weight:bold'></span><br/><br/><div align='center' style='font-family:verdana;font-size:11px'><strong>Date :</strong>" + System.DateTime.Now.ToShortDateString() + "</div><br/><div align='center' style='font-family:verdana;font-size:11px'><strong>School Name :</strong>" + Session[ApplicationSession.SCHOOLNAME].ToString() + "</div><br/><div align='center' style='font-family:verdana;font-size:11px'></div><br/><div align='center' style='font-family:verdana;font-size:11px'></div><br/><div align='center' style='font-family:verdana;font-size:11px'></div><br/><div align='center' style='font-family:verdana;font-size:11px'><strong></strong></div>" +
                     "<br/>"
                   + "<br/>" + sw.ToString() + "<br/>";
                Response.Output.Write(content);
