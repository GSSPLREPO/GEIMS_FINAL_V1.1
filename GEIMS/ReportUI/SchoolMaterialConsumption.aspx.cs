...
{
    public partial class SchoolMaterialConsumption : PageBase
    {
        private static ILog logger = LogManager.GetLogger(typeof(SchoolMaterialConsumption));
        ...
        {
            BindConsumptionsGrid(txtConsumptionFromDate.Text, txtConsumptionTodate.Text, 0);
        }
        #endregion
        ...
        protected void btnExportPDF_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=MaterialConsumptionList" + Session[ApplicationSession.SCHOOLNAME].ToString().Replace(" ", "_").Replace("<br/>", "") + "_" + DateTime.Now.Date.ToString("yyyy-mm-dd") +".pdf");
        ...
        protected void btnExportExcel_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=MaterialConsumptionList" + Session[ApplicationSession.SCHOOLNAME].ToString().Replace(" ", "_").Replace("<br/>", "") + "_" + DateTime.Now.Date.ToString("yyyy-mm-dd") +".xls");
                Response.Charset = "";
        ...
        protected void btnExportWord_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=MaterialConsumptionList" + Session[ApplicationSession.SCHOOLNAME].ToString().Replace(" ", "_").Replace("<br/>", "") + "_" + DateTime.Now.Date.ToString("yyyy-mm-dd") + ".doc");
                Response.Charset = "";
