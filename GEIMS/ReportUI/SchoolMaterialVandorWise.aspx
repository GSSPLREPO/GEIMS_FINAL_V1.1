<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="SchoolMaterialVandorWise.aspx.cs" Inherits="GEIMS.ReportUI.SchoolMaterialVandorWise" %>
                                    ...
                                    <div runat="server" id="divVandor" style="width: 100%; float: left;" class="label">
                                        <div style="padding: 10px;">
                                            ...
                                            <div style="text-align: left; width: 70%; float: left;">
                                                ...
                                                <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlVandor"
											SetFocusOnError="true" ErrorMessage="*" CssClass="Required" InitialValue="-1"></asp:RequiredFieldValidator>--%>
                                            </div>
                                        </div>
                                    </div>
