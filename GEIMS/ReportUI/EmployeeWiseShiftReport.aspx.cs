...
{
    public partial class EmployeeWiseShiftReport : System.Web.UI.Page
    {
        private static ILog logger = LogManager.GetLogger(typeof(EmployeeWiseShiftReport));
        #region Page Load
        ...
        #region Bind Employee Shift Grid
        public void BindEmployeeShift()
        {
            ApplicationResult objResult = new ApplicationResult();
            EmployeeattendanceBl objEmployeeattendanceBl = new EmployeeattendanceBl();

            objResult = objEmployeeattendanceBl.Employeeshift_Select_ForEmployeeWiseShaift(Convert.ToInt32(hfSearchName.Value), txtFromDate.Text, txtToDate.Text);
            ...
            if (objResult.resultDT.Rows.Count > 0)
            {
                ...
                lblSchoolName.Text = Session[ApplicationSession.TRUSTNAME].ToString();
                lblEmployeeName.Text = txtSearchName.Text;
                lblFromDate.Text = txtFromDate.Text;
                lblToDate.Text = txtToDate.Text;
                lblSchool1.Text = Session[ApplicationSession.TRUSTNAME].ToString();
            }
            else
            {
                divReport.Visible = false;
        ...
        protected void btnExportPDF_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=EmployeeWiseShift" + Session[ApplicationSession.TRUSTNAME].ToString().Replace(" ", "_").Replace("<br/>", "") + "_" + DateTime.Now.Date.ToString("dd-MM-yyyy") + ".pdf");
        ...
        protected void btnExportExcel_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=EmployeeWiseShift" + Session[ApplicationSession.TRUSTNAME].ToString().Replace(" ", "_").Replace("<br/>", "") + "_" + DateTime.Now.Date.ToString("dd-MM-yyyy") + ".xls");
                Response.Charset = "";
                ...
                string content = "<div align='center' style='font-family:verdana;font-size:13px'><span style='font-size:16px:font-weight:bold;color:Maroon;'>Employee Wise Shift Report</span><br/><span style='font-size:13px:font-weight:bold'></span><br/><span align='center' style='font-family:verdana;font-size:11px'><strong>Date :</strong>" + System.DateTime.Now.ToShortDateString() + "</span><br/><span align='center' style='font-family:verdana;font-size:11px'><strong>School Name :</strong>" + Session[ApplicationSession.TRUSTNAME].ToString() + "</span><br/><span align='center' style='font-family:verdana;font-size:11px'><strong>Employee Name:</strong>" + txtSearchName.Text + "</span><br/><span align='center' style='font-family:verdana;font-size:11px'><strong>From Date:</strong>" + txtFromDate.Text + "</span><br/><span align='center' style='font-family:verdana;font-size:11px'><strong>To Date:</strong>" + txtToDate.Text + "</span><br/></span><br/><div align='left' style='font-family:verdana;font-size:11px'>  </div>" + sw.ToString() + "<br/>";
                Response.Output.Write(content);
        ...
        protected void btnExportWord_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=EmployeeWiseShift" + Session[ApplicationSession.TRUSTNAME].ToString().Replace(" ", "_").Replace("<br/>", "") + "_" + DateTime.Now.Date.ToString("dd-MM-yyyy") + ".doc");
                Response.Charset = "";
