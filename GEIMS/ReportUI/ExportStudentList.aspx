<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="ExportStudentList.aspx.cs" Inherits="GEIMS.ReportUI.ExportStudentList" %>
    ...
    ClientValidationFunction="Validate" ForeColor="Red"></asp:CustomValidator>--%>
                                    ...
                                    <div style="width: 100%; float: left; padding-top: 0px;" class="label">
                                        <div style="padding: 10px; padding-right: 30px;">
                                            <div style="float: left; text-align: center; width: 100%; padding-bottom: 10px;">
                                                <asp:ImageButton visible="false" ID="btnExportPDF" runat="server" ImageUrl="~/Images/adobe.PNG"
                    ...
                    <asp:ImageButton ID="btnExportExcel" runat="server" ImageUrl="~/Images/excel.PNG"
                        ToolTip="Export to Excel" OnClick="btnExportExcel_Click" />
                                                &nbsp;
                    <asp:ImageButton visible="false" ID="btnExportWord" runat="server" ImageUrl="~/Images/word.PNG"
                        ToolTip="To export data in this format selected fields is maximum 10." OnClick="btnExportWord_Click" />
                                    ...
                                    <div style="width: 100%; float: left; padding-top: 0px;" class="label">
                                        <div style="padding: 10px; padding-right: 30px;">
                                            <div style="float: left; text-align: center; width: 100%; padding-bottom: 10px;">
                                                <b>Report : Export Student List</b>
                                            </div>
                                        </div>
                                    </div>
                                    <div style="width: 100%; float: left; padding-top: 0px;" class="label">
                                    ...
                                    <div id="ReportDiv" runat="server" style="padding: 10px; padding-right: 30px; overflow: scroll; width: 1100px">
                                     ...
                                     <div id="ExportDiv" visible="false" runat="server" style="padding: 10px; padding-right: 30px; overflow: scroll; width: 1100px" >
                                        <asp:GridView ID="GvExport" Visible="true" runat="server" BackColor="White" BorderColor="Black" AutoGenerateColumns="true" 
                                            CellPadding="4" Font-Names="Verdana" Font-Size="11px" Width="100%">
                                            <RowStyle BackColor="White" />
                                            <FooterStyle BackColor="White" Font-Names="Verdana" Font-Size="11px" ForeColor="#333333" />
                                            <PagerStyle BackColor="#336666" ForeColor="White" HorizontalAlign="Center" />
