<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="SchoolStudentCategoryWise.aspx.cs" Inherits="GEIMS.ReportUI.SchoolStudentCategoryWise" %>
                                ...
                                <div id="divReport" runat="server" style="width: 100%; float: left; padding-top: 0px;" class="label">
                                    ...
                                    <div style="width: 100%; float: left; padding-top: 0px;" class="label">
                                        <asp:GridView ID="gvReport" Visible="true" runat="server" BackColor="White" BorderColor="Black" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="ClassName" HeaderText="વર્ગનું નામ">
                                                ...
                                                <asp:BoundField DataField="StudentCount" HeaderText="કુલ વિદ્યાર્થી">
                                                    <HeaderStyle Width="5%" HorizontalAlign="left" VerticalAlign="Top" />
                                                    <ItemStyle HorizontalAlign="left" Width="10%" VerticalAlign="Top" Wrap="true" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="MaleSCCount" HeaderText="અનુશુચિત જાતિના પુરુષો">
                                                    <HeaderStyle Width="5%" HorizontalAlign="left" VerticalAlign="Top" />
                                                    <ItemStyle HorizontalAlign="left" Width="10%" VerticalAlign="Top" Wrap="true" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="FemaleSCCount" HeaderText="અનુશુચિત જાતિની સ્ત્રીઓ">
                                                    <HeaderStyle Width="5%" HorizontalAlign="left" VerticalAlign="Top" />
                                                    <ItemStyle HorizontalAlign="left" Width="10%" VerticalAlign="Top" Wrap="true" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="MaleSTCount" HeaderText="અનુશીચિત જનજાતિના પુરુષો">
                                                    <HeaderStyle Width="5%" HorizontalAlign="left" VerticalAlign="Top" />
                                                    <ItemStyle HorizontalAlign="left" Width="10%" VerticalAlign="Top" Wrap="true" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="FemaleSTCount" HeaderText="અનુશીચિત જનજાતિની સ્ત્રીઓ">
                                                    <HeaderStyle Width="5%" HorizontalAlign="left" VerticalAlign="Top" />
                                                    <ItemStyle HorizontalAlign="left" Width="10%" VerticalAlign="Top" Wrap="true" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="MaleOBCCount" HeaderText="બક્ષીપંચ જાતિના પુરુષો">
                                                    <HeaderStyle Width="5%" HorizontalAlign="left" VerticalAlign="Top" />
                                                    <ItemStyle HorizontalAlign="left" Width="10%" VerticalAlign="Top" Wrap="true" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="FemaleOBCCount" HeaderText="બક્ષીપંચ જાતિની સ્ત્રીઓ">
                                                    <HeaderStyle Width="5%" HorizontalAlign="left" VerticalAlign="Top" />
                                                    <ItemStyle HorizontalAlign="left" Width="10%" VerticalAlign="Top" Wrap="true" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="MaleOtherCount" HeaderText="અન્ય જાતિના પુરુષો">
                                                    <HeaderStyle Width="5%" HorizontalAlign="left" VerticalAlign="Top" />
                                                    <ItemStyle HorizontalAlign="left" Width="10%" VerticalAlign="Top" Wrap="true" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="FemaleOtherCount" HeaderText="અન્ય જાતિની સ્ત્રીઓ">
                                                    <HeaderStyle Width="5%" HorizontalAlign="left" VerticalAlign="Top" />
                                                    <ItemStyle HorizontalAlign="left" Width="10%" VerticalAlign="Top" Wrap="true" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="MaleTotalCount" HeaderText="પુરુષોની કુલસંખ્યા">
                                                    <HeaderStyle Width="5%" HorizontalAlign="left" VerticalAlign="Top" />
                                                    <ItemStyle HorizontalAlign="left" Width="10%" VerticalAlign="Top" Wrap="true" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="FemaleTotalCount" HeaderText="સ્ત્રીઓની કુલસંખ્યા">
                                                    <HeaderStyle Width="5%" HorizontalAlign="left" VerticalAlign="Top" />
                                                    <ItemStyle HorizontalAlign="left" Width="10%" VerticalAlign="Top" Wrap="true" />
                                                </asp:BoundField>
                                            </Columns>
