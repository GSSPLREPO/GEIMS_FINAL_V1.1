<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="MaterialPurchase.aspx.cs" Inherits="GEIMS.ReportUI.MaterialPurchase" %>
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                ...
                <div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
                    ...
                    <div id="tabs-1" style="min-height: 150px;">
                        ...
                        <asp:Panel ID="pnlTransferInfo" runat="server" GroupingText="Material Transfer Details">
                            <div style="width: 100%; float: left;" class="label">
                                <div style="padding: 10px;">
                                    <div style="text-align: right; width: 30%; float: left;" class="label">
                                        Vendor:<span style="color: red">*</span>
                                    </div>
                                    <div style="text-align: left; width: 70%; float: left;">
                                        <asp:DropDownList runat="server" CssClass="validate[required] TextBox" ID="ddlVendor" Width="50%">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div style="width: 100%; float: left;" class="label">
                                <div style="float: left; width: 100%; text-align: center;">
                                    ...
                                    <asp:TextBox ID="txtTransferFromDate" runat="server" CssClass="TextBox" Width="150px" Height="100%"></asp:TextBox>&nbsp;&nbsp;&nbsp;
                                    ...
                                    <asp:TextBox ID="txtTransferTodate" runat="server" CssClass="TextBox" Width="150px" Height="100%"></asp:TextBox>&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:ImageButton ID="btnExportWord" runat="server" ImageUrl="~/Images/word.PNG"
                        ToolTip="Export to Word" OnClick="btnExportWord_Click" />
                            ...
                            <div style="width: 100%; float: left; padding-top: 0px;" class="label">
                                <div style="padding: 10px; padding-right: 30px;">
                                    <div style="float: left; text-align: center; width: 100%; padding-bottom: 10px;">
                                        <b>Report : Material Transfer List</b>
                                    </div>
                                </div>
                            </div>
                            <div style="width: 100%; float: left; padding-top: 0px;" class="label">
