<%@ Page Language="C#"  MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="EmployeePayrollReport.aspx.cs" Inherits="GEIMS.ReportUI.EmployeePayrollReport" %>
                                    ...
                                    <div style="width: 100%; float: left;" class="label">
                                        <div style="padding: 10px;">
                                            ...
                                            <div style="float:Left; width: 30%;">
                                                <asp:DropDownList ID="ddlMonth" runat="server" CssClass="validate[required] Droptextarea" Width="210px">
                                            ...
                                            <div style="float: left; width: 30%;">
                                                <asp:DropDownList ID="ddlYear" runat="server" CssClass="validate[required] Droptextarea" Width="210px" OnSelectedIndexChanged="ddlYear_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </div>
