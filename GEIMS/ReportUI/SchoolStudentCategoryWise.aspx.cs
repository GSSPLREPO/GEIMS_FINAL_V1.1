...
{
    public partial class SchoolStudentCategoryWise : PageBase
    {
        ...
        public void BindAcademicYear()
        {
            try
            {
                ...
                objResults = objSchoolBl.School_Select(Convert.ToInt32(Convert.ToInt32(Convert.ToInt32(Session[ApplicationSession.SCHOOLID]))));
        ...
        {
            Response.Redirect("../Client.UI/SchoolReports.aspx?Mode=SchoolStatutoryReports");
        }
        #endregion
