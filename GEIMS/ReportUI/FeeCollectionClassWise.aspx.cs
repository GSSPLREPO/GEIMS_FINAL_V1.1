...
{
    public partial class FeeCollectionClassWise : PageBase
    {
        private static ILog logger = LogManager.GetLogger(typeof(FeeCollectionClassWise));
        ...
        protected void btnExportPDF_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=FeesCollectionClassWise" + "_" + DateTime.Now.Date.ToString("yyyy-MM-dd") + ".pdf");
        ...
        protected void btnExportExcel_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename= FeesCollectionClassWise" + "_" + DateTime.Now.Date.ToString("yyyy-MM-dd") + ".xlsx");
                Response.Charset = "";
        ...
        protected void btnExportWord_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=FeesCollectionClassWise" + "_" + DateTime.Now.Date.ToString("yyyy-MM-dd") + ".doc");
                Response.Charset = "";
        ...
        public void BindSchoolFeesList()
        {
            ...
            objResult = objFeesCollectionBl.FeesCollection_Select_byClasslWise(Convert.ToInt32(Session[ApplicationSession.TRUSTID]), Convert.ToInt32(ddlSchool.SelectedValue), ddlYear.SelectedItem.Text);
            if (objResult.resultDT.Rows.Count > 0)
            {
