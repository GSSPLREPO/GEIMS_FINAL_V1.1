<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="EmployeeMonthlyAttendance.aspx.cs" Inherits="GEIMS.ReportUI.EmployeeMonthlyAttendance" %>
                                ...
                                <div id="divReport" runat="server" style="width: 100%; float: left; padding-top: 0px;" class="label">
                                    ...
                                    <div style="width: 100%; float: left; padding-top: 0px;" class="label">
                                        <div style="padding: 10px; padding-right: 30px;">
                                            ...
                                            <asp:Label ForeColor="red" runat="server">Note *:  '*' Considered as <strong>Holiday</strong></asp:Label>  <br/>
                                            <asp:Label ForeColor="red" runat="server">Note *:  '-' Considered as <strong>Week End</strong></asp:Label>  <br/>
                                            <asp:Label ForeColor="red" runat="server">Note *:  'CL/ML/DL..etc.' Considered as <strong>Approved Leave</strong></asp:Label>  <br/>
                  ...
                  <div id="divSchool1" style="width: 100%; padding-top: 0px; display: none;">
                    <div id="div1" runat="server" style="width: 100%; float: left; padding-top: 0px;" class="label">
                        <div style="width: 100%; float: left; padding-top: 0px;" class="label">
                            <div style="padding: 10px; padding-right: 20px;">
                                <div style="float: left; text-align: center; width: 100%; padding-bottom: 10px;">
                                    <b>Report : Employee Attendance Report</b>
                                </div>
                            </div>
                        </div>
                        <div style="width: 100%; float: left; padding-top: 0px;" class="label">
