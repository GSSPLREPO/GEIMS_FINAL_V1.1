...
{
    public partial class MaterialConsumption : PageBase
    {
        private static ILog logger = LogManager.GetLogger(typeof(MaterialConsumption));
        ...
        protected void btnExportPDF_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename= MaterialConsumptionList" + "_" + DateTime.Now.Date.ToString("yyyy-mm-dd") +".pdf");
        ...
        protected void btnExportExcel_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=MaterialConsumptionList" + "_" + DateTime.Now.Date.ToString("yyyy-mm-dd") +".xls");
                Response.Charset = "";
        ...
        protected void btnExportWord_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename==MaterialConsumptionList" + "_" + DateTime.Now.Date.ToString("yyyy-mm-dd") +".doc");
                Response.Charset = "";
