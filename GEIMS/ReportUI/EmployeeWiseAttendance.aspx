<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="EmployeeWiseAttendance.aspx.cs" Inherits="GEIMS.ReportUI.EmployeeWiseAttendance" %>
            ...
            $(".autosuggest").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        url: "EmployeeWiseAttendance.aspx/GetAllEmployeeNameForReport",
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                ...
                <div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
                    ...
                    <div id="tabs-1" style="min-height: 150px;">
                        ...
                        <asp:Panel ID="pnlStudentAttendanceInfo" runat="server" GroupingText="Employee Attendance">
                            ...
                            <div style="width: 100%; padding-bottom: 20px; float: left;" class="label">
                             ...
                             <div style="width: 100%; padding-bottom: 20px; float: left;" class="label">
                                ...
                                <div style="width: 80%; float: left;">
                                   <asp:DropDownList ID="ddlabsentHalfday" Width="150px" CssClass="textarea" runat="server" Enabled="True">
                                        <asp:ListItem Value="-1">-Select-</asp:ListItem>
                                        <asp:ListItem Value="1">Absent / Halfday</asp:ListItem>
                                       <%-- <asp:ListItem Value="2">Employee Code</asp:ListItem>--%>
                                    </asp:DropDownList>
                                    &nbsp;&nbsp;&nbsp;
                               </div>
                    ...
                    <asp:ImageButton ID="btnExportWord" runat="server" ImageUrl="~/Images/word.PNG"
                        ...
                        <div id="divReport" runat="server" style="width: 100%; float: left; padding-top: 0px;" class="label">
                            ...
                            <div style="padding: 10px; padding-right: 30px; overflow: scroll; width: 1100px">
                                <asp:GridView ID="gvReport" Visible="true" runat="server" BackColor="White" BorderColor="Black" AutoGenerateColumns="True" OnPreRender="gvReport_PreRender"
                                    CellPadding="4" Font-Names="Verdana" Font-Size="11px" AllowSorting="false" Width="100%">
                                    <RowStyle BackColor="White" />
                                    <FooterStyle BackColor="White" Font-Names="Verdana" Font-Size="11px" ForeColor="#333333" Font-Bold="True"/>
