...
{
    public partial class SchoolEmployeeList : PageBase
    {
        private static ILog logger = LogManager.GetLogger(typeof(SchoolEmployeeList));
        ...
        protected void btnExportPDF_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=SchoolEmployeeList" + Session[ApplicationSession.SCHOOLNAME].ToString().Replace(" ", "_").Replace("<br/>", "") + "_" + DateTime.Now.Date.ToString("yyyy-mm-dd") +".pdf");
        ...
        protected void btnExportExcel_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename= EmployeeList" + "_" + Session[ApplicationSession.SCHOOLNAME] + "_" + DateTime.Now.Date.ToString("yyyy-MM-dd") + ".xlsx");
                Response.Charset = "";
        ...
        protected void btnExportWord_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=SchoolEmployeeList" + Session[ApplicationSession.SCHOOLNAME].ToString().Replace(" ", "_").Replace("<br/>", "") + "_" + DateTime.Now.Date.ToString("yyyy-mm-dd") +".doc");
                Response.Charset = "";
