...
{
    public partial class MaterialTransferReport : PageBase
    {
        private static ILog logger = LogManager.GetLogger(typeof(MaterialTransferReport));
        ...
        protected void btnExportPDF_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename= MaterialTransferList" + "_" + DateTime.Now.Date.ToString("dd-MM-yyyy") +".pdf");
        ...
        protected void btnExportExcel_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename= MaterialTransferList"+"_" + DateTime.Now.Date.ToString("dd-MM-yyyy")+".xls");
                Response.Charset = "";
        ...
        protected void btnExportWord_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename= MaterialTransferList" + "_" + DateTime.Now.Date.ToString("dd-MM-yyyy") +".doc");
                Response.Charset = "";
