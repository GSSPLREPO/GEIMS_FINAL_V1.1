<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="ClassWiseResultReport.aspx.cs" Inherits="GEIMS.Result.ClassWiseResultReport" %>
                           ...
                           <%-- <div style="width: 100%; float: left; padding-top: 0px;" class="label">
                            ...
                            <div style="padding: 10px; padding-right: 30px; overflow: scroll; width: 1100px">
                                <asp:GridView ID="gvReport" Visible="true" runat="server" BackColor="White" BorderColor="Black" AutoGenerateColumns="true"
                                    CellPadding="4" Font-Names="Verdana" Font-Size="11px" AllowSorting="false" OnRowDataBound="gvReport_RowDataBound">
