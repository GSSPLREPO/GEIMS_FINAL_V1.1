...
{
    public partial class ClassWiseResultReport : System.Web.UI.Page
    {
        #region Declaration
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objResult = objExamConfigurationBL.ExamConfiguration_Select_Result_ClassWise(Convert.ToInt32(ddlClass.SelectedValue), Convert.ToInt32(ddlDivision.SelectedValue),
        ...
        protected void btnExportPDF_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=MarksReport" + Session[ApplicationSession.SCHOOLNAME].ToString().Replace(" ", "_").Replace("<br/>", "") + "_" + DateTime.Now.Date.ToString("yyyy-mm-dd") + lblClass.Text +'_'+ ".pdf");
        ...
        protected void btnExportExcel_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename= MarksReport" + "_" + Session[ApplicationSession.SCHOOLNAME] + "_" + DateTime.Now.Date.ToString("yyyy-MM-dd") + lblClass.Text + '_'  + ".xlsx");
                Response.Charset = "";
        ...
        protected void btnExportWord_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=MarksReport" + Session[ApplicationSession.SCHOOLNAME].ToString().Replace(" ", "_").Replace("<br/>", "") + "_" + DateTime.Now.Date.ToString("yyyy-mm-dd") + lblClass.Text + '_' + ".doc");
                Response.Charset = "";
