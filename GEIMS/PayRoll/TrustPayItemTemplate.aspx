<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="TrustPayItemTemplate.aspx.cs" Inherits="GEIMS.PayRoll.TrustPayItemTemplate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div id="tab-panel" class="style-tabs" visible="true">
                        ...
                        <div id="tabs-1" style="padding:5px" class="gradientBoxesWithOuterShadows">
                                ...
                                <div style="text-align: left; float: left; width: 100%;">
                                    <asp:DropDownList ID="ddlSchool" CssClass="validate[required] TextBox" runat="server"  Width="280px" Height="25px" AutoPostBack="True" OnSelectedIndexChanged="ddlSchool_SelectedIndexChanged" >
                            ...
                            <div style="width: 100%;">
                                <div style="padding-top: 50px; padding-bottom: 10px; width: 100%;">
                                    <asp:GridView ID="gvPayItem" runat="server" AutoGenerateColumns="False"
                                        ...
                                        Font-Names="verdana" Font-Size="12px" Width="100%" BackColor="White" style="text-align: center" >
    ...
    <script type="text/javascript">
        ...
        $("[id*=chkHeader]").click(function () {
            ...
            if ($(this).is(":checked")) {
                $('[id*=CheckBoxPayItem]').prop("checked", true);
                ...
                $('[id*=CheckBoxPayItem]').prop("checked", false);
        ...
        $("[id*=CheckBoxPayItem]").click(function () {
            //alert("chkChild");
            if ($(this).is(":checked")) {
                //alert("CHecked");
                $(document.getElementById('<%= btnSave.ClientID %>')).prop("disabled", false);
            ...
            if ($('[id*=CheckBoxPayItem]').length == $('[id*=CheckBoxPayItem]:checked').length) {
                   //alert("In");
            ...
            if ($('[id*=CheckBoxPayItem]').length == $('[id*=CheckBoxPayItem]:not(:checked)').length) {
                 $(document.getElementById('<%= btnSave.ClientID %>')).prop("disabled", true);
                 $(document.getElementById('<%= btnSave.ClientID %>')).css("background-color", "#848484");
             }
        });
