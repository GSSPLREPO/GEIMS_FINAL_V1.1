<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="SchoolSalarySummary.aspx.cs" Inherits="GEIMS.PayRoll.SchoolSalarySummary" %>
                                                ...
                                                <table style="width: 100%; font-size: 14px; vertical-align: top; height: 100%; border-collapse: collapse; border: 1px solid black">
                                                  ...
                                                  <%--  <tr>
                                                    ...
                                                    <tr>
                                                        <%--<td colspan="1" style="border: 1px solid black"></td>--%>
                                                        <td colspan="3" style="border: 1px solid black; vertical-align: top">
                                                            <asp:GridView ID="gvEarning1" runat="server" HorizontalAlign="left" Width="100%">
                                                            </asp:GridView>
                                                        </td>
                                                        <td colspan="3" style="border: 1px solid black; vertical-align: top">
                                                            <asp:GridView ID="gvDeduction1" runat="server" HorizontalAlign="Left" Width="100%">
                                                            </asp:GridView>
                                                        </td>
                                                    </tr>
                                                    <tr>
