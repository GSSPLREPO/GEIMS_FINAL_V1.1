<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="PayItem.aspx.cs" Inherits="GEIMS.PayRoll.PayItem" %>
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                ...
                <div id="tabs" runat="server">
                    <div id="tab-panel" class="style-tabs" visible="true">
                        <ul>
                            <li><a id="tabClassDetails" href="#tabs-1">Pay Item</a></li>
                        </ul>
                            ...
                            <div style="width: 100%;">
                                <div style="width: 100%" class="divclasswithfloat">
                                    ...
                                    <div style="text-align: left; width: 80%; float: left;">
                                        <asp:TextBox ID="txtPayItemName" runat="server" Width="300px" CssClass="validate[required] TextBox" onKeyUp="CheckTextLength(this,25)"></asp:TextBox>
                                        <%--<asp:TextBox ID="txtPayItemName" runat="server" Width="300px" CssClass="validate[required] TextBox" onkeypress="return AllowAlphabet(event)"></asp:TextBox>--%>
                                    </div>
                                </div>
                                <div style="width: 100%" class="divclasswithfloat">
                                    <div style="text-align: left; width: 20%; float: left;" class="label">
                                    ...
                                    <div style="text-align: left; float: left; width: 80%;">
                                        <asp:TextBox ID="txtPayItemDescription" runat="server" CssClass="TextArea" Width="300px" Height="50px" TextMode="MultiLine" onKeyUp="CheckTextLength(this,150)"></asp:TextBox>
                                    </div>
                                </div>
                                <div style="width: 100%" class="divclasswithfloat">
                                    <div style="text-align: left; width: 20%; float: left;" class="label">
                                    ...
                                    <fieldset>
                                        ...
                                        <div style="width: 100%" class="divclasswithfloat">
                                            ...
                                            <div style="text-align: left; float: left; width: 100%;">
                                               <asp:DropDownList ID="ddlDeduction" runat="server" CssClass="validate[required] Droptextarea"  style="margin-top: 5px;">
