    ...
    public partial class EmployeeMonthlyBankStatement : System.Web.UI.Page
    {
        ...
        protected void btnExportExcel_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename= BankStatement" + "_" + Session[ApplicationSession.TRUSTNAME] + "_" + DateTime.Now.Date.ToString("yyyy-MM-dd") + ".xls");
                Response.Charset = "";
        ...
        protected void btnExportWord_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Bank Statement" + "_" + DateTime.Now.Date.ToString("yyyy-MM-dd") + ".doc");
                Response.Charset = "";
