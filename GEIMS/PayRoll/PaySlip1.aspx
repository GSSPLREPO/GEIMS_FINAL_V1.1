<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="PaySlip1.aspx.cs" Inherits="GEIMS.PayRoll.PaySlip1" %>
                            ...
                            <div id="tabs-1" style="min-height: 150px;padding:5px">
                                ...
                                <div id="divReport" runat="server" style="width: 100%; float: left; padding-top: 0px;" class="label">
                                    ...
                                    <div style="padding: 10px; padding-right: 30px; width: 100%">
                                        <asp:DataList ID="dlPaySlip" Width="100%" runat="server" align="center" Style="font-family: Verdana; font-size: 8px; border: solid 2px black; padding-left: 2px" OnItemDataBound="dlPaySlip_ItemDataBound">
                                            <HeaderTemplate>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <table style="width: 100%; font-size: 14px; vertical-align: top; height: 100%; border-collapse: collapse; border: 1px solid black">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="border: 1px solid black; padding-left: 5px"><%--<%# Eval("DepartmentName") %>--%>NA</td>
                                                    </tr>
                                                     <!-- CHNAGE ROW 3 -->
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td style="border: 1px solid black; padding-left: 5px"><%# Eval("DeptJoin") %></td>
                                                        <td colspan="2" style="border: 1px solid black; padding-left: 5px"><%--<%# Eval("EmployeeName") %>--%>NA</td>
                                                        <td colspan="2" style="border: 1px solid black; padding-left: 5px"><%--<%# Eval("DesignationName") %>--%>NA</td>
                                                        <td style="border: 1px solid black; padding-left: 5px"><%--<%# Eval("DepartmentName") %>--%>NA</td>
                                                    </tr>
                                                     <!-- CHNAGE ROW 4 -->
                                                    <tr>
                                                        <td colspan="1" style="border: 1px solid black; padding-left: 5px"><strong>PR DAYS</strong></td>
                                                        <td colspan="2" style="border: 1px solid black; width: 30%; padding-left: 5px"><strong>OP BAL CL</strong></td>                 
                                                        <td colspan="2" style="border: 1px solid black; width: 10%; padding-left: 5px"><strong>OP BAL EL</strong></td>
                                                        <td style="border: 1px solid black; width: 12%; padding-left: 5px"><strong>OP BAL SL</strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="border: 1px solid black; padding-left: 5px"><%# Eval("TotalDaysofMonth") %></td>
                                                        <td colspan="2" style="border: 1px solid black; padding-left: 5px"><%--<%# Eval("EmployeeName") %>--%>NA</td>
                                                        <td colspan="2" style="border: 1px solid black; padding-left: 5px"><%--<%# Eval("DesignationName") %>--%>NA</td>
                                                        <td style="border: 1px solid black; padding-left: 5px"><%--<%# Eval("DepartmentName") %>--%>NA</td>
                                                    </tr>
                                                      <!-- CHNAGE ROW 5 -->
                                                    <tr>
                                                        <td colspan="1" style="border: 1px solid black; padding-left: 5px"><strong>&nbsp;</strong></td>
                                                        <td colspan="2" style="border: 1px solid black; width: 30%; padding-left: 5px"><strong>OD</strong></td>                 
                                                        <td colspan="2" style="border: 1px solid black; width: 10%; padding-left: 5px"><strong>SP LEAVE</strong></td>
                                                        <td style="border: 1px solid black; width: 12%; padding-left: 5px"><strong>PAY DAYS</strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="border: 1px solid black; padding-left: 5px">&nbsp;</td>
                                                        <td colspan="2" style="border: 1px solid black; padding-left: 5px"><%--<%# Eval("EmployeeName") %>--%>NA</td>
                                                        <td colspan="2" style="border: 1px solid black; padding-left: 5px"><%--<%# Eval("DesignationName") %>--%>NA</td>
                                                        <td style="border: 1px solid black; padding-left: 5px"><%# Eval("EarnedDaysofMonth") %></td>
                                                    </tr>
                                                     <!-- CHNAGE ROW 6 -->
                                                    <tr>
                                                        <td colspan="1" style="border: 1px solid black; padding-left: 5px"><strong>UTILISED LEAVE</strong></td>
                                                        <td colspan="2" style="border: 1px solid black; width: 30%; padding-left: 5px"><strong>CL</strong></td>                 
                                                        <td colspan="2" style="border: 1px solid black; width: 10%; padding-left: 5px"><strong>EL</strong></td>
                                                        <td style="border: 1px solid black; width: 12%; padding-left: 5px"><strong>SL</strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="border: 1px solid black; padding-left: 5px">NA</td>
                                                        <td colspan="2" style="border: 1px solid black; padding-left: 5px"><%--<%# Eval("EmployeeName") %>--%>NA</td>
                                                        <td colspan="2" style="border: 1px solid black; padding-left: 5px"><%--<%# Eval("DesignationName") %>--%>NA</td>
                                                        <td style="border: 1px solid black; padding-left: 5px"><%--<%# Eval("DepartmentName") %>--%>NA</td>
                                                    </tr>
                                                    <!-- CHNAGE ROW 7 -->
                                                    <tr>
                                                        <td colspan="1" style="border: 1px solid black; padding-left: 5px"><strong>BALANCE LEAVE</strong></td>
                                                        <td colspan="2" style="border: 1px solid black; width: 30%; padding-left: 5px"><strong>CL BAL CL</strong></td>                 
                                                        <td colspan="2" style="border: 1px solid black; width: 10%; padding-left: 5px"><strong>CL BAL EL</strong></td>
                                                        <td style="border: 1px solid black; width: 12%; padding-left: 5px"><strong>CL BAL SL</strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="border: 1px solid black; padding-left: 5px">NA</td>
                                                        <td colspan="2" style="border: 1px solid black; padding-left: 5px"><%--<%# Eval("EmployeeName") %>--%>NA</td>
                                                    ...
                                                    <tr>
                                                        <%--<td colspan="1" style="border: 1px solid black"></td>--%>
                                                        <td colspan="1" style="border: 1px solid black; vertical-align: top; padding-left: 5px"><strong>GROSS SALARY  </strong></td>
                                                        <td colspan="2" style="border: 1px solid black"><strong><%# Eval("TotalEarning") %></strong></td>
                                                        <td colspan="2" style="border: 1px solid black; vertical-align: top; padding-left: 5px"><strong>TOTAL </strong></td>
                                                ...
                                                <table style="width: 100%; font-size: 14px; vertical-align: top; height: 100%; border-collapse: collapse; border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 30%; border: 1px solid black; padding-left: 5px"><%# Eval("TotalEarning") %></td>
                                                    ...
                                                    <tr>
                                                        <td style="width: 20%; border: 1px solid black; padding-left: 5px"><strong>TOTAL INCOME</strong></td>
                                                        <td style="width: 30%; border: 1px solid black; padding-left: 5px"><%# Eval("NetSalary") %></td>
                                                        <td style="width: 50%; border: 1px solid black; padding-left: 5px" colspan="2">
                                                        <asp:Label runat="server" ID="lblAmountInWords"></asp:Label></td>
                                                    </tr>
