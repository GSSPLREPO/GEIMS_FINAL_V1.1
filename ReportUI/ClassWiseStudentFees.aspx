<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="ClassWiseStudentFees.aspx.cs" Inherits="GEIMS.ReportUI.ClassWiseStudentFees" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="divMain" style="width: 100%; text-align: left; padding-top: 5px;">
        <div id="divTitle" class="pageTitle" style="width: 100%;">
            Class Wise Student fees Collection
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                ...
                <div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
                    ...
                    <div id="tabs-1" style="min-height: 150px;">
                        ...
                        <asp:Panel ID="pnlFeesCollectionInfo" runat="server" GroupingText="Fees Collection Details">
                    ...
                    <asp:ImageButton ID="btnExportWord" runat="server" ImageUrl="~/Images/word.PNG"
                        ToolTip="Export to Word" OnClick="btnExportWord_Click" />
                            ...
                            <div style="width: 100%; float: left; padding-top: 0px;" class="label">
                             ...
                             <span style="color: red">Note * : "$" Considered as Outstandingfees <br>
                                    Note * : Blank Space Considered as Not applicable <br>
                                </span>
                            <div style="padding: 10px; padding-right: 30px;  overflow: scroll;width: 100%; float: left">
                                 
                                <asp:GridView ID="gvReport" Visible="true" runat="server" BackColor="White" BorderColor="Black" AutoGenerateColumns="True"
                                    CellPadding="3" Font-Names="Verdana" Font-Size="11px" AllowSorting="false" Width="100%" OnRowDataBound="gvReport_OnRowDataBound">
