<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="SarasariReport.aspx.cs" Inherits="GEIMS.ReportUI.SarasariReport" %>
                            ...
                            <div style="width: 100%; float: left;" class="label">
                                <div style="padding: 10px;">
                                    ...
                                    <div style="float: left; width: 85%;">
                                        <asp:DropDownList ID="ddlSchool" runat="server" CssClass="validate[required] Droptextarea" Width="260px" AutoPostBack="true" Enabled="true" OnSelectedIndexChanged="ddlSchool_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </div>
