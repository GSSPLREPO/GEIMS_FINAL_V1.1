                            ...
                            <div id="tabs-1" style="padding: 5px 5px 5px 5px;" class="gradientBoxesWithOuterShadows">
								...
								<asp:TextBox ID="txtMMLastName" runat="server" CssClass="validate[custom[onlyLetterSp]] TextBox" placeholder="Last Name" Width="150px"></asp:TextBox>
                                        ...
                                        <div style="width: 100%;" class="divclasswithfloat">
                                            <fieldset>
                                                ...
                                                <div style="width: 100%;" class="divclasswithfloat">
                                                    ...
                                                    <div style="text-align: left; width: 30%; float: left;">
                                                        <asp:TextBox ID="txtHeight" runat="server" CssClass="TextBox" Width="150px"></asp:TextBox>
									...
									Width="30px" OnClick="btnForward_Click" />--%>
                                            ...
                                            <div style="float: left; width: 47%;" class="divclasswithfloat">
                                                <fieldset>
                                            ...
                                            <div id="divResign" style="width: 100%;">
                                                ...
                                                <div style="width: 100%;" class="divclasswithfloat">
                                                    ...
                                                    <div style="text-align: left; width: 81%; float: left;">
                                                        ...
                                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender7" OnClientShown="calendarShown" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtLastWorkingDate" TargetControlID="txtLastWorkingDate">
                                                        </ajaxToolkit:CalendarExtender>
                                                    </div>
                                ...
                                <div style="width: 100%;">
                                    ...
                                    <div id="divEmpExpirence">
                                        ...
                                        <div style="width: 100%;" class="divclasswithfloat">
                                            ...
                                            <div style="text-align: left; width: 79%; float: left;">
                                                <asp:TextBox ID="txtCTC" runat="server" CssClass="validate[required] TextBox" Width="150px"></asp:TextBox>
                                            </div>
