<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="DepartmentMaster.aspx.cs" Inherits="GEIMS.Client.UI.DepartmentMaster" %>
                        ...
                        <div style="width: 100%;">
                            <div class="divclasswithfloat">
                                ...
                                <div style="text-align: left; width: 80%; float: left;">
                                    <asp:TextBox ID="txtDepartmentNameENG" runat="server" CssClass="validate[required] TextBox" Width="50%" ></asp:TextBox>
                                </div>
                            </div>
                            <div class="divclasswithfloat">
                                <div style="text-align: left; width: 20%; float: left;" class="label">
