        ...
        <div id="divContent" style="height: 100%; font-family: Verdana;">
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                ...
                <div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
                    <ul>
                        <li><a id="tabClassDetails" href="#tabs-1">Budget SubHeading Details</a></li>
                    </ul>
                        ...
                        <div style="width: 100%; float: left;">
                            <div style="height: 30px; margin-top: 10px; width: 100%;">
                                ...
                                <div style="text-align: left; width: 80%; float: right;">
                                    <asp:DropDownList runat="server" CssClass="TextBox" ID="ddlBudgetCategory" Width="50%" Height="100%" AutoPostBack="True" OnSelectedIndexChanged="ddlBudgetCategory_SelectedIndexChanged" />
                                </div>
                            </div>
                            <div style="height: 30px; margin-top: 10px; width: 100%;">
                                <div style="text-align: left; width: 20%; float: left;" class="label">
                                ...
                                <div style="text-align: left; float: left; width: 80%;">
                                    <asp:DropDownList runat="server" CssClass="TextBox" ID="ddlBudgetHeading" Width="50%" Height="100%" />
                                </div>
                            </div>
                            <div style="height: 30px; margin-top: 10px; width: 100%;">
                                <div style="text-align: left; width: 20%; float: left;" class="label">
