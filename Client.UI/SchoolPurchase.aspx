<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="SchoolPurchase.aspx.cs" Inherits="GEIMS.Client.UI.SchoolPurchase" %>
                        ...
                        <div id="tabs-2" class="gradientBoxesWithOuterShadows" style="float: left; width: 100%;">
                            ...
                            <div id="divSchoolOrTrust" style="width: 100%; float: left;" class="label">
                                <div style="padding: 10px;">
                                    ...
                                    <div style="float: left; width: 85%;">
                                        <asp:RadioButtonList ID="rblSchoolOrTrust" runat="server" RepeatDirection="Horizontal">
                                ...
                                <div style="text-align: center; padding-top: 10px; float: left; padding-bottom: 10px; width: 100%;">
                                    <asp:UpdatePanel ID="upGridSchool" UpdateMode="Conditional" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:GridView ID="gvMaterialForTrust" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                                BorderColor="#3B5998" BorderWidth="3px" BorderStyle="Solid" CellPadding="4" GridLines="Both"
                                                Font-Names="verdana" Font-Size="12px" Width="100%" BackColor="White">
                                                <FooterStyle BackColor="White" ForeColor="White" />
                                                <RowStyle BackColor="White" Height="20px" ForeColor="#333333" />
                                                <Columns>
                                                    <asp:BoundField DataField="TrustMID" HeaderText="ID">
                                                        <HeaderStyle BackColor="#9097A9" HorizontalAlign="Left" VerticalAlign="Middle" CssClass="hidden" />
                                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Wrap="false" CssClass="hidden" />
                                                        <FooterStyle CssClass="hidden" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="TrustNameEng" HeaderText="Trusts">
                                                        <HeaderStyle Width="70%" HorizontalAlign="Center" VerticalAlign="Top" />
                                                        <ItemStyle HorizontalAlign="left" Width="70%" VerticalAlign="Top" Wrap="true" />
                                                    </asp:BoundField>
                                                    <asp:TemplateField HeaderText="Stock">
                                                        ...
                                                        <FooterTemplate>
                                                            <asp:Label ID="lblTotalQuantity1" runat="server" CssClass="lblTotalQuantity1" Text="0" />
                                                        </FooterTemplate>
                                                        <ItemStyle HorizontalAlign="left" Width="20%" VerticalAlign="Top" Wrap="true" />
                                                    </asp:TemplateField>
                                                </Columns>
                            ...
                            <div style="width: 100%" id="divMultipleMaterialTransfer">
                                ...
                                <div style="text-align: center; padding-top: 10px; float: left; padding-bottom: 10px; width: 100%;">
                                    <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Conditional" runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="gvMultipleMaterial0" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                BorderColor="#3B5998" BorderWidth="3px" BorderStyle="Solid" CellPadding="4" GridLines="Both"
                                                Font-Names="verdana" Font-Size="12px" Width="100%" BackColor="White" OnRowDataBound="gvMultipleMaterial0_RowDataBound">
                                                <FooterStyle BackColor="White" ForeColor="White" />
                                                <RowStyle BackColor="White" Height="20px" ForeColor="#333333" />
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Available Quantity">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblMainQuantity0" runat="server" Text='<%# Bind("MainQuantity") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="left" Width="10%" VerticalAlign="Top" Wrap="true" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Stock">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtQuantity0" runat="server" Width="150px" CssClass="TextBox" onkeypress="return NumericKeyPressFraction(event)">0</asp:TextBox>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="left" Width="20%" VerticalAlign="Top" Wrap="true" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Trust Selection">
                                                        <ItemTemplate>
                                                            <asp:DropDownList runat="server" CssClass="TextBox" ID="ddlGridTrust" Width="250px">
                                                            </asp:DropDownList>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="School Selection">
                                                        <ItemTemplate>
                                                            <asp:DropDownList runat="server" CssClass="TextBox" ID="ddlGridSchool0" Width="250px">
                                                            </asp:DropDownList>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
...
$('#<%= ddlTMaterialGroup.ClientID %>').change(function () {
            ...
            if (MaterialGroupId != '') {
                $.ajax({
                    ...
                    url: "SchoolPurchase.aspx/GetMaterial",
...
$(document.getElementById('<%= ddlTMaterialName.ClientID %>')).change(function () {
        ...
        if (MaterialId != '') {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "SchoolPurchase.aspx/GetUOM",
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "SchoolPurchase.aspx/GetMaterialQuantity",
                data: "{'MaterialID':'" + MaterialId + "','TrustID':'" + <%=Session["TrustID"] %> + "','SchoolID':'" + <%=Session["SchoolID"] %> + "'}",
                dataType: "json",
                success: function (data) {
                    var count = -1;
                    var temp = $.parseJSON(data.d);
    ...
    function gridChekbox() {
        ...
        $('#<%=gvMaterialForTrust.ClientID %>').find("input:checkbox").click(function () {
        ...
        $('#<%=gvMultipleMaterial0.ClientID %> tr').each(function () {
            var totalStock = 0;
        ...
        function CalculateStock() {
            ...
            var StockToMinus = 0;
            var i = 0;
            var TotalStock1 = 0, ToalValue1 = 0;
            var StockToMinus1 = 0;
            var i1 = 0;
            ...
            var RowCount1 = $('#<%=gvMaterialForTrust.ClientID %> tr').length;
            ...
            $('#<%=gvMaterialForTrust.ClientID %> tr').each(function () {
                if (i1 != 0) {
                    if (i1 != RowCount1 - 1) {
                        if ($(this).find('input:checkbox').is(":checked")) {
                            TotalStock1 += parseInt($(this).closest("tr").find($("[id*=txtQuantity]")).val());
                            StockToMinus1 = parseInt($(this).closest("tr").find($("[id*=txtQuantity]")).val());
                        }
                    }
                }
                i1 = i1 + 1;
                if (MainQuantity < TotalStock1) {
                    $(this).closest("tr").find($("[id*=chkChild]")).removeAttr("checked");
                    $(this).closest("tr").find($("[id*=txtQuantity]")).val("0");

                }
            });
            $('.lblTotalQuantity1').text(TotalStock1);
            if (MainQuantity < TotalStock1) {
                alert("Total Stock is Not Greater Than Main Quantity");
                ToalValue1 = TotalStock1 - StockToMinus1;
                $('.lblTotalQuantity1').text(parseInt(ToalValue1));
            }
        }
        ...
        $('#<%= btnAdd.ClientID %>').
                ...
                //var vars = $("#aspnetForm").serialize();
                var i = 0;
                var rowCount = $('#<%=gvMultipleMaterial0.ClientID %> tr').length;
            $('#<%=gvMultipleMaterial0.ClientID %> tr').each(function () {
                    if (i != 0) {
        ...
        function ClearOnTransfer() {
            ...
            $(document.getElementById('<%= gvMultipleMaterial0.ClientID %>')).hide();
            $('#<%=rblMaterialSelection.ClientID%> input:radio:checked').each(function () {
                if (($(this).val()) == "0") {
                    $("#divBtnTransfer").hide();
                    $(document.getElementById('<%= ddlTMaterialGroup.ClientID %>')).Val('');
                $(document.getElementById('<%= ddlTMaterialName.ClientID %>')).Val('');
                $(document.getElementById('<%= ddlTUOM.ClientID %>')).Val('');
                $(document.getElementById('<%= txtAvailableQuantity.ClientID %>')).val("0");
            } else {
...
$('#<%=txtTransferFromDate.ClientID%>').change(function () {
    ...
    $("#btnViewListMain").click(function () {
        ...
        $('#<%=rblSchoolOrTrust.ClientID%>').click(function () {
            $('#<%=rblSchoolOrTrust.ClientID%> input:radio:checked').each(function () {
        if (($(this).val()) == "0") {
            ClearOnTransfer();
            $("#divSingleMaterialTransfer").show();
            $("#divMultipleMaterialTransfer").hide();
