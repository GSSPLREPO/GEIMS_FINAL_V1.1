<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="GeneratePaySlip.aspx.cs" Inherits="GEIMS.PayRoll.GeneratePaySlip" %>
            ...
            <div id="divContent2" style="width: 80%; float: left;">
                <div id="tabs" runat="server" class="gradientBoxesWithOuterShadows" visible="True" style="width: 100%; float: left;">
                    <div style="float: left; width: 100%;">
                        <ul>
                            <li><a id="tabTransferDetails" href="#tabs-2">PaySlip Details</a></li>
                        </ul>
                    </div>
                                        ...
                                        <div style="padding: 10px;">
                                            ...
                                            <div style="float: left; width: 20%;">
                                                <asp:Button ID="btnChange" runat="server" Text="Change" Width="50px" Font-Size="X-Small" CssClass="btn-blue-new btn-blue-medium"
                                                    OnClick="btnChange_Click" Visible="False" />
                                                <asp:Label ID="Label12" runat="server" Text="Earned Days :"></asp:Label>
                                            </div>
                                            <div style="float: left; width: 30%;">
                                                <asp:TextBox ID="txtPayEarnedDays" CssClass="TextBox" runat="server" Enabled="False">0</asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div style="float: left; width: 100%;">
                                                        ...
                                                        <div style="width: 100%; float: left;">
                                                            <div style="padding: 10px;">
                                                                ...
                                                                <div style="float: left; width: 59%;">
                                                                    <asp:TextBox ID="txtPayAbsenceDay" runat="server" AutoPostBack="True" OnTextChanged="txtPayAbsenceDay_TextChanged" CssClass="TextBox">0</asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div style="width: 100%; float: left;" class="label">
                                        <div style="padding: 10px;">
                                            <div style="float: left; width: 100%; text-align: center">
                                                ...
                                                <asp:TextBox ID="txtTotal" runat="server" Height="19px" Enabled="False" ReadOnly="True" CssClass="TextBox">0</asp:TextBox>
                                                <asp:Label ID="lblerror" runat="server" Font-Bold="True" Font-Italic="False" ForeColor="Red"
                                                    Text="Out of Attendence Index" Visible="False"></asp:Label>&nbsp;&nbsp;&nbsp;
