<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="PayItemMaster.aspx.cs" Inherits="GEIMS.PayRoll.PayItemMaster" %>
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                <div id="divGrid" runat="server" style="text-align: center; padding-top: 10px; padding-bottom: 10px; padding-right:10px; width: 100%;">
                    ...
                    <asp:GridView ID="gvPayItem" runat="server" AutoGenerateColumns="False"
                        ...
                        Font-Names="verdana" Font-Size="12px" Width="100%" BackColor="White" OnRowCommand="gvPayItem_OnRowCommand"
                ...
                <div id="tabs" runat="server" class="style-tabs" visible="true" style="width: 100%;">
                    ...
                    <div id="tabs-1" style="height: 220px;padding:0 0 0 10px" class="gradientBoxesWithOuterShadows">
                        <div style="width: 100%; float: left;">
                            <div style="height: 30px; margin-top: 10px; width: 100%;">
                                ...
                                <div style="text-align: left; width: 80%; float: right;">
                                    <asp:TextBox ID="txtPayItemName" runat="server" CssClass="validate[required] TextBox"></asp:TextBox>
                                </div>
                            </div>
                            <div style="height: 30px; margin-top: 10px; width: 100%;">
                                <div style="text-align: left; width: 20%; float: left;" class="label">
                                ...
                                <div style="text-align: left; float: left; width: 80%;">
                                    <asp:DropDownList runat="server" ID="ddlType" CssClass="validate[required] Droptextarea">
                            ...
                            <div style="height: 30px; margin-top: 10px; width: 100%;">
                                ...
                                <div style="text-align: left; float: left; width: 80%;">
                                    <asp:TextBox ID="txtDescription" runat="server" CssClass="validate[required] TextArea" TextMode="MultiLine"></asp:TextBox>
                                </div>
                            </div>
                        </div>
